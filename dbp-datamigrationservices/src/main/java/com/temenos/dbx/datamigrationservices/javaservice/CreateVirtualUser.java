...
public class CreateVirtualUser implements JavaService2 {

	LoggerUtil logger = new LoggerUtil(CreateVirtualUser.class);
	...
	public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		try {
            ...
            return migrationResource.createVirtualUser(methodId, inputArray, request, response);
        } catch (Exception e) {
