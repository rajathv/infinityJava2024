...
import com.temenos.dbx.datamigrationservices.javaservice.UpdateApprovalMatrixMode;
...
public class UpdateApprovalMatrixModeTest {
	...
	Object[] inputArray;
	Result actualResult;
	MigrateApprovalModeResource migrationResource;
	...
	public void executedBefore() throws Exception {
		...
		migrationResource = mock(MigrateApprovalModeResource.class);
		...
		when(resourceFactory.getResource(MigrateApprovalModeResource.class))
		.thenReturn(migrationResource);
		javaService2 = new UpdateApprovalMatrixMode();
	}
	...
	public void testInvokeCreateContract() throws Exception {
		...
		when(migrationResource.updateApprovalMode(methodID, inputArray, request, response)).thenReturn(result);
