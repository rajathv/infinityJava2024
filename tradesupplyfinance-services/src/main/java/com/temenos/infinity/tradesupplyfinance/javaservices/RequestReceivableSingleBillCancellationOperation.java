 ...
 */
public class RequestReceivableSingleBillCancellationOperation implements JavaService2 {
    @Override
    public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request, DataControllerResponse response) throws IOException {
        ...
        return requestResource.requestSingleBillCancellation(inputDto, request);
    }
}
