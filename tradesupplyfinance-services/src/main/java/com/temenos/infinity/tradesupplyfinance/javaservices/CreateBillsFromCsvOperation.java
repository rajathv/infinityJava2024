 ...
 */
public class CreateBillsFromCsvOperation implements JavaService2 {
    @Override
    public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request, DataControllerResponse response) throws Exception {
        ...
        ReceivableCsvImportDTO inputDto = JSONUtils.parse(new JSONObject(inputParams).toString(), ReceivableCsvImportDTO.class);
        return requestResource.createBillsCsvImport(inputDto, request);
    }
}
