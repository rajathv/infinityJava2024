...
import static com.temenos.infinity.tradesupplyfinance.utils.PdfGenerator.FontStyle.HEADING;
import static com.temenos.infinity.tradesupplyfinance.utils.PdfGenerator.FontStyle.SUBHEADING_DARK;
...
public class PdfGenerator {
    ...
    private static final Color lightFont = new Color(114, 114, 114);
    private static final Color darkFont = new Color(66, 66, 66);
    private static final Color blueFont = new Color(66, 135, 245);
