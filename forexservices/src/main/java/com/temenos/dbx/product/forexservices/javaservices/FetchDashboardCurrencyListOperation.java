...
public class FetchDashboardCurrencyListOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(FetchDashboardCurrencyListOperation.class);
	@Override
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			LOG.error("Error occured while invoking FetchDashboardCurrencyListOperation: ", e);
