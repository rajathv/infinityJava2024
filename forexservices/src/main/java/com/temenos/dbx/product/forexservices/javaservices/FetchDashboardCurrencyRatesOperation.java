...
public class FetchDashboardCurrencyRatesOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(FetchDashboardCurrencyRatesOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = forexResource.fetchDashboardCurrencyRates(methodID, inputArray, request, response);
		}
		catch(Exception e) {
