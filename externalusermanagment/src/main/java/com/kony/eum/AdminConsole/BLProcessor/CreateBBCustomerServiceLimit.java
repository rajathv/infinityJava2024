...
public class CreateBBCustomerServiceLimit implements JavaService2 {
	private static final Logger LOG = Logger.getLogger(CreateBBCustomerServiceLimit.class);
    @Override
