...
public class GetUserNameRulesAndPolicy implements JavaService2 {
	private static final Logger LOG = Logger.getLogger(GetUserNameRulesAndPolicy.class);
    @Override
