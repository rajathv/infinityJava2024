...
public class GetUserNameAndPasswordrules implements JavaService2 {
	private static final Logger LOG = Logger.getLogger(GetUserNameAndPasswordrules.class);
    @Override
