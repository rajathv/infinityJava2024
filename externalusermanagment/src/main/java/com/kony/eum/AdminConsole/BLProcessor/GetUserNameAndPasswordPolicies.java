...
public class GetUserNameAndPasswordPolicies implements JavaService2 {
	private static final Logger LOG = Logger.getLogger(GetUserNameAndPasswordPolicies.class);
    @Override
