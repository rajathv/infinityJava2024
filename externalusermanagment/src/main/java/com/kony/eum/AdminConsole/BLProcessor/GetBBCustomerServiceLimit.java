...
public class GetBBCustomerServiceLimit implements JavaService2 {
	private static final Logger LOG = Logger.getLogger(GetBBCustomerServiceLimit.class);
    @Override
