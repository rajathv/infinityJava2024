...
public class SaveInternationalAccountsInSessionTask implements ObjectProcessorTask {
	private static final Logger LOG = LogManager.getLogger(SaveInternationalAccountsInSessionTask.class);
	...
	public boolean process(FabricRequestManager fabricRequestManager, FabricResponseManager fabricResponseManager)
		...
		try {
			...
			if (null != response && !response.isJsonNull()) {
				...
				acctManager.saveInternationalBankAccountsIntoSession(accountsMap);
			}
		} catch (Exception e) {
