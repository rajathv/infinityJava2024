...
public class SaveSameBankAccountsInSessionTask implements ObjectProcessorTask {
	private static final Logger LOG = LogManager.getLogger(SaveSameBankAccountsInSessionTask.class);
	...
	public boolean process(FabricRequestManager fabricRequestManager, FabricResponseManager fabricResponseManager)
		...
		try {
			...
			if (null != response && !response.isJsonNull()) {
				...
				acctManager.saveSameBankAccountsIntoSession(accountsMap);
			}
		} catch (Exception e) {
