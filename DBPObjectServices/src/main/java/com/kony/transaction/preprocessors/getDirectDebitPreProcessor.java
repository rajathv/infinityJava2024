...
import com.kony.task.datavalidation.GetDirectDebitServiceValidation;
...
public class getDirectDebitPreProcessor implements ObjectServicePreProcessor {
    ...
    public void execute(FabricRequestManager fabricReqManager, FabricResponseManager fabricResManager,
        ...
        Class<? extends ObjectProcessorTask>[] tasks = new Class[] {
        		GetDirectDebitServiceValidation.class
        		};
