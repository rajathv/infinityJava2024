...
public class CreateBulkTranferObjectServicePreProcessor
		implements ObjectServicePreProcessor, ObjectServicesConstants, ObjectProcessorTask {

	private static final Logger logger = LogManager.getLogger(CreateBulkTranferObjectServicePreProcessor.class);
	...
	public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager,
		...
		if(responsePayloadHandler.getPayloadAsJson() != null)
		...
		String eventSubType = PARAM_PAY_MULTIPLE_BENEFICIARIES_CREATE_TRANSFER;
		String producer = "";
	...
	public boolean process(FabricRequestManager requestManager, FabricResponseManager responseManager)
		...
		try {
			...
			logger.error("Exception occured in create bulk transfer pre processor", e);
