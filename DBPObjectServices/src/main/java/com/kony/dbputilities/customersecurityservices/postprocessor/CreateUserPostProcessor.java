...
public class CreateUserPostProcessor implements ObjectServicePostProcessor {
...
//				URLConstants.MFA_SERVICE_DELETE);
		...
		com.kony.dbputilities.util.HelperMethods.callApiAsync(requestManager, hashMap,
				HelperMethods.getHeaders(requestManager), URLConstants.MFA_SERVICE_DELETE);
