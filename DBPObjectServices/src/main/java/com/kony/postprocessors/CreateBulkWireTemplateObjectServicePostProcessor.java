...
public class CreateBulkWireTemplateObjectServicePostProcessor
	...
	private static final Logger logger = LogManager.getLogger(CreateBulkWireTemplateObjectServicePostProcessor.class);
	...
	public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
		...
		try {
			...
			logger.error("Exception occured in ObjectService PostProcessor while Creating BULKWIRE TEMPLATE=", ex);
		}
