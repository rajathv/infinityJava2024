...
public class UpdateBulkWireTemplateObjectServicePostProcessor
		implements ObjectServicePostProcessor, ObjectServicesConstants, ObjectProcessorTask {

	private static final Logger logger = LogManager.getLogger(UpdateBulkWireTemplateObjectServicePostProcessor.class);
	...
	public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
		...
		try {
			...
			String producer = "BulkWireObjects/operations/BulkWire/UpdateBulkWireTemplate";
			...
			logger.error("Exception occured in ObjectService PostProcessor while Updating BULKWIRE TEMPLATE=", ex);
		}
