...
public class CancelScheduledTransactionOccurrenceObjectServicePostProcessor
        implements ObjectServicePostProcessor, ObjectServicesConstants {

    private static final Logger logger = LogManager
            .getLogger(CancelScheduledTransactionOccurrenceObjectServicePostProcessor.class);
    ...
    public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
        ...
        try {
            ...
            String eventSubType = PARAM_DELETE_SCHEDULED_TRANSACTION_OCCURRENCE;
            String producer = "Transactions/cancelScheduledTransactionOccurrence";
            ...
            logger.error(
                    "exception occured in ObjectService PostProcessor while deleting scheduled Transaction occurrence=",
                    ex);
        }
