...
public class UpdateUserAccountSettingsObjectServicePostProcessor
        implements ObjectServicePostProcessor, ObjectServicesConstants {

    private static final Logger logger = LogManager.getLogger(UpdateUserAccountSettingsObjectServicePostProcessor.class);
    ...
    public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
        ...
        try {
            ...
            String eventSubType = PARAM_ACCOUNT_UPDATE;
            String producer = "Accounts/updateUserAccountSettings";
            ...
            logger.error("exception occured in UpdateUserAccountSettings ObjectService PostProcessor ", ex);
        }
