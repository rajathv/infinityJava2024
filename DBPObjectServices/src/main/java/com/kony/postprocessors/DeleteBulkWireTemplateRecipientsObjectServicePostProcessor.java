...
public class DeleteBulkWireTemplateRecipientsObjectServicePostProcessor
		implements ObjectServicePostProcessor, ObjectServicesConstants, ObjectProcessorTask {

	private static final Logger logger = LogManager.getLogger(DeleteBulkWireTemplateRecipientsObjectServicePostProcessor.class);
	...
	public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
		...
		try {
			...
			String eventSubType = PARAM_UPDATE_BULKWIRE_TEMPLATE;
			customParams.addProperty("info", "Bulkwire template recipient(s) deleted");
			
			String producer = "BulkWireObjects/operations/BulkWire/DeleteBulkWireTemplateRecipient";
			...
			logger.error("Exception occured in ObjectService PostProcessor while Deleting BULKWIRE TEMPLATE RECIPIENTS=", ex);
		}
