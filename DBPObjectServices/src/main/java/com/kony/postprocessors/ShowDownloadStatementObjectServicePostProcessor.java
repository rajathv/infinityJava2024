...
public class ShowDownloadStatementObjectServicePostProcessor
        implements ObjectServicePostProcessor, ObjectServicesConstants {

    private static final Logger logger = LogManager.getLogger(ShowDownloadStatementObjectServicePostProcessor.class);
    ...
    public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
        ...
        try {
            ...
            String eventSubType = PARAM_INTACC_STATEMENT_FETCH;
            String producer = "AccountStatement/showDownloadStatement";
            ...
            logger.error("exception occured in ShowDownloadStatementObjectServicePostProcessor ", ex);
        }
