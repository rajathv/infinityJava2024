...
public class DeleteBulkWireTemplateObjectServicePostProcessor
		implements ObjectServicePostProcessor, ObjectServicesConstants, ObjectProcessorTask {

	private static final Logger logger = LogManager.getLogger(DeleteBulkWireTemplateObjectServicePostProcessor.class);
	...
	public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
		...
		try {
			...
			String eventSubType = PARAM_DELETE_BULKWIRE_TEMPLATE;
			String producer = "BulkWireObjects/operations/BulkWire/DeleteBulkWireTemplate";
			...
			logger.error("Exception occured in ObjectService PostProcessor while deleting BULKWIRE TEMPLATE=", ex);
		}
