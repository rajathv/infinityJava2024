...
public class AccountsManager {
    ...
    public boolean validateExternalPayeeId(String customerId,String payeeId,String accountNumber) {
    	SessionMap extactmap = getExternalBankAccountsFromSession(customerId);
    	if(extactmap==null)
    		return false;
    	return extactmap.hasKey(accountNumber) && extactmap.hasKey(payeeId);
    }
