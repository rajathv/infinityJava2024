...
import com.kony.postprocessors.AddPayeeRecipientObjectServicePostProcessor;
...
/**
 * 
 * Used id: addRecipient
 *
 */
public class AddPayeePostProcessor implements ObjectServicePostProcessor {
    ...
    public void execute(FabricRequestManager fabricReqManager, FabricResponseManager fabricResManager)
        ...
        Class<? extends ObjectProcessorTask>[] tasks = new Class[] { PayeeReloadTask.class,
                AddPayeeRecipientObjectServicePostProcessor.class };
