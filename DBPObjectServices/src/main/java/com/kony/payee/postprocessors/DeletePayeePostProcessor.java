...
import com.kony.postprocessors.DeleteBillPayeeObjectServicePostProcessor;
 ...
 *
 */
public class DeletePayeePostProcessor implements ObjectServicePostProcessor {
    ...
    public void execute(FabricRequestManager fabricReqManager, FabricResponseManager fabricResManager)
        ...
        Class<? extends ObjectProcessorTask>[] tasks = new Class[] { PayeeReloadTask.class,
                DeleteBillPayeeObjectServicePostProcessor.class };
