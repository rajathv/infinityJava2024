 ...
 * @author naveen.yerra
 */
public class FetchAllTradeDetails implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(FetchAllTradeDetails.class);
    ...
    public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
        ...
        try {
            ...
            return dashboardResource.fetchAllDetails(input, request);
        }
        catch (Exception e) {
