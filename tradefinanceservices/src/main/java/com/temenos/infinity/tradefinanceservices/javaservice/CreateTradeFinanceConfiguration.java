 ...
 * @author naveen.yerra
 */
public class CreateTradeFinanceConfiguration implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(CreateTradeFinanceConfiguration.class);
    ...
    public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
        ...
        try {
            ...
            return resource.createTradeFinanceConfiguration(input, request);
        }
        catch (Exception e) {
