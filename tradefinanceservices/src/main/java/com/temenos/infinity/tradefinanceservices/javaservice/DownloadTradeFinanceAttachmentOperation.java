 ...
 */
public class DownloadTradeFinanceAttachmentOperation implements JavaService2 {

    private static final Logger LOG = LogManager.getLogger(DownloadTradeFinanceAttachmentOperation.class);
