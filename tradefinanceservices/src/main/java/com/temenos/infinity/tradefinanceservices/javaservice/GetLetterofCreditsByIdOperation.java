...
public class GetLetterofCreditsByIdOperation implements JavaService2{
	private static final Logger LOG = LogManager.getLogger(GetLetterofCreditsByIdOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			GetLetterofCreditsByIdResource letterOfCreditsResource = DBPAPIAbstractFactoryImpl
                    .getResource(GetLetterofCreditsByIdResource.class);
            LetterOfCreditsDTO letterOfCredit = constructPayload(request);                  
            Result result = letterOfCreditsResource.getLetterOfCreditsByID(letterOfCredit, request);
            return result;
        } catch (Exception e) { 
	...
	public static LetterOfCreditsDTO constructPayload(DataControllerRequest request){
	    ...
	    String maximumCreditAmount = request.getParameter("maximumCreditAmount") != null ? request.getParameter("maximumCreditAmount") : "";
