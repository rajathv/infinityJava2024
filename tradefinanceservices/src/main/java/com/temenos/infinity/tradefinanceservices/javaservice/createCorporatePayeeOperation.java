...
public class createCorporatePayeeOperation implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(createCorporatePayeeOperation.class);
    ...
    public Object invoke(String s, Object[] objects, DataControllerRequest dataControllerRequest, DataControllerResponse dataControllerResponse) throws Exception {
        ...
        try {
            return payeesResource.createCorporatePayee(inputParams, dataControllerRequest);
        } catch (Exception e) {
