 ...
 * @author naveen.yerra
 */
public class FetchTradeFinanceConfiguration implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(FetchTradeFinanceConfiguration.class);
    ...
    public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
        ...
        try {
            ...
            return resource.fetchTradeFinanceConfiguration(input, request);
        }
        catch (Exception e) {
