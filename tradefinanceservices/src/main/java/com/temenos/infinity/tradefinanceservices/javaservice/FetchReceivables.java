 ...
 * @author naveen.yerra
 */
public class FetchReceivables implements JavaService2 {
    ...
    public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
        ...
        try {
            DashboardResource receivablesResource = DBPAPIAbstractFactoryImpl.getResource(
                    DashboardResource.class);
            Map<String, Object> input = (Map<String, Object>) inputArray[1];
            return receivablesResource.fetchReceivables(input, request);
        }
        catch (Exception e) {
