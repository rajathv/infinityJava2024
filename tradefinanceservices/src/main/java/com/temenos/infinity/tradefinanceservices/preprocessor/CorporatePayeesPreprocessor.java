...
import com.temenos.infinity.tradefinanceservices.preprocessor.validations.CorporatePayeeValidation;

public class CorporatePayeesPreprocessor implements ObjectServicePreProcessor {
    @Override
    public void execute(FabricRequestManager fabricRequestManager, FabricResponseManager fabricResponseManager, FabricRequestChain fabricRequestChain) throws Exception {
        ...
        Class<? extends ObjectProcessorTask>[] tasks = new Class[]{CorporatePayeeValidation.class};
