 ...
 * @author naveen.yerra
 */
public class ReceivablesExcelBusinessDelegateImpl extends DashboardBusinessDelegateImpl implements ExcelBusinessDelegate {
    ...
    public <T> List<T> getList(DataControllerRequest request) throws ApplicationException {
        return (List<T>) dashboardBusinessDelegate.fetchReceivables(new HashMap<>(), request);
    }
