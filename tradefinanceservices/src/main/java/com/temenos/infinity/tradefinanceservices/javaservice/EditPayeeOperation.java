...
public class EditPayeeOperation implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(EditPayeeOperation.class);
    ...
    public Object invoke(String s, Object[] objects, DataControllerRequest dataControllerRequest, DataControllerResponse dataControllerResponse) throws Exception {
        ...
        try {
            return payeesResource.editPayee(inputParams, dataControllerRequest);
        } catch (Exception e) {
