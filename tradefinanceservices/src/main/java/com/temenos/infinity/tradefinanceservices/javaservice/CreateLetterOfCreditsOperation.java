 ...
 * 
 *
 * @version Java Service to create the letter of credits request in order management micro services
 * 
 */
public class CreateLetterOfCreditsOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
            ...
            LOG.error("Unable to create order for letter of credits request from OMS: "+e);
	...
	public static LetterOfCreditsDTO constructPayload(DataControllerRequest request){
	    ...
	    String transferable= request.getParameter("transferable") != null ? request.getParameter("transferable") : "";   
	    String standByLC= request.getParameter("standByLC") != null ? request.getParameter("standByLC") : "";   
...
//        String isDraft = request.getParameter("isDraft") != null ? request.getParameter("isDraft") : "";
        ...
        String srmsReqOrderID = ((request.getParameter("srmsReqOrderID") != null)&& !(request.getParameter("srmsReqOrderID").equalsIgnoreCase(""))) ? request.getParameter("srmsReqOrderID") : "";
        ...
        letterOfCredit.setStatus(status);
...
//        letterOfCredit.setIsDraft(isDraft);
	    ...
	    letterOfCredit.setSignatoryApprovalRequired(signatoryApprovalRequired);
