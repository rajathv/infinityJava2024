...
public class updateIssuedGuaranteeClaimByBankOperation implements JavaService2 {
    @Override
    public Object invoke(String methodId, Object[] objects, DataControllerRequest dataControllerRequest,
        ...
        return claimsResource.updateClaimByBank(methodId, inputParams, dataControllerRequest);
    }
}
