...
public class UpdateDrawingByBankOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(UpdateDrawingByBankOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = drawingsResource.updateDrawingByBank(updatePayloadDTO, request);
			return result;
		} catch (Exception e) {
