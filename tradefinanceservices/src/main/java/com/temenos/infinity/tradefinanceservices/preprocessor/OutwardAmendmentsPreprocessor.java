...
import com.temenos.infinity.tradefinanceservices.preprocessor.validations.OutwardAmendmentsValidation;

/**
 * @author k.meiyazhagan
 */
public class OutwardAmendmentsPreprocessor implements ObjectServicePreProcessor {
    @Override
    public void execute(FabricRequestManager fabricRequestManager, FabricResponseManager fabricResponseManager, FabricRequestChain fabricRequestChain) throws Exception {
        Class<? extends ObjectProcessorTask>[] tasks = new Class[]{OutwardAmendmentsValidation.class};
