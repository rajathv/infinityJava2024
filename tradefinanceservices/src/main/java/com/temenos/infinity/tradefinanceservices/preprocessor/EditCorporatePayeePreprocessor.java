...
import com.temenos.infinity.tradefinanceservices.preprocessor.validations.GuaranteeLinkedPayeeValidation;

public class EditCorporatePayeePreprocessor implements ObjectServicePreProcessor {
    @Override
    public void execute(FabricRequestManager fabricRequestManager, FabricResponseManager fabricResponseManager, FabricRequestChain fabricRequestChain) throws Exception {
        ...
        Class<? extends ObjectProcessorTask>[] tasks = new Class[]{GuaranteeLinkedPayeeValidation.class};
