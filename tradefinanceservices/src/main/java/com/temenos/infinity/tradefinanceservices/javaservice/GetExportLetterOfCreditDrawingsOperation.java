...
public class GetExportLetterOfCreditDrawingsOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			Result result = exportResource.getExportLetterOfCreditDrawings(inputArray, request);
			return result;
		} catch (Exception e) {
			LOG.error("Unable to get ExportLC Drawings Requests from OMS: " + e);
