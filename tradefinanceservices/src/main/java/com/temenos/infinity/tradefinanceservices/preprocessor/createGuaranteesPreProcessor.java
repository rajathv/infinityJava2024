...
import com.temenos.infinity.tradefinanceservices.preprocessor.validations.GuaranteesValidation;

public class createGuaranteesPreProcessor implements ObjectServicePreProcessor {
    @Override
    public void execute(FabricRequestManager fabricRequestManager, FabricResponseManager fabricResponseManager, FabricRequestChain fabricRequestChain) throws Exception {
        ...
        Class<? extends ObjectProcessorTask>[] tasks = new Class[]{GuaranteesValidation.class};
