package com.temenos.dbx.eum.product.contract.servlet;
...
import com.temenos.dbx.eum.product.contract.mapper.ContractBackendDelegateMapper;
import com.temenos.dbx.eum.product.contract.mapper.ContractBusinessDelegateMapper;
import com.temenos.dbx.eum.product.contract.mapper.ContractResourceMapper;

@IntegrationCustomServlet(servletName = "EumContractCustomResourceServlet", urlPatterns = {
        "EumContractCustomResourceServlet" })
