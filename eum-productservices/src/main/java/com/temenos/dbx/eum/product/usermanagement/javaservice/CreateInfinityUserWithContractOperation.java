 ...
 *
 */
public class CreateInfinityUserWithContractOperation implements JavaService2{
    ...
    public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
        ...
        return infinityUserManagementResource.createInfinityUserWithContract(methodId, inputArray, request, response);
    }
}
