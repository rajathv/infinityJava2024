...
public class DBXCustomerCommunicationData implements JavaService2  {

	private static final Logger LOG = 
			Logger.getLogger(DBXCustomerCommunicationData.class);
	@Override
	public Object invoke(String methodId, Object[] inputArray,
		...
		try {
			...
			result = resource.DBXCustomerCommunicationDetails(methodId, inputArray, request, response);
