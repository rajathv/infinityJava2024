...
public interface InfinityUserManagementBusinessDelegate extends BusinessDelegate {
     ...
     * @throws ApplicationException
     */
    DBXResult getAllEligibleRelationalCustomers(String coreCustomerId, Map<String, Object> headersMap,
     ...
     * @throws ApplicationException
     */
    DBXResult getInfinityUserAccountsForAdmin(Boolean isSuperAdmin, CustomerAccountsDTO dto, Map<String, Object> headersMap)
            throws ApplicationException;
	...
	DBXResult getCoreCustomerFeatureActionLimits(String roleId, String coreCustomerId, String legalEntityId,
			String userId, Map<String, Object> headersMap) throws ApplicationException;

	DBXResult getUserApprovalPermissions(String userId, String userName, String legalEntityId, String coreCustomerId,
