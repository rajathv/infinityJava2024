...
import com.temenos.dbx.eum.product.usermanagement.javaservice.ExistingPasswordVerifyOperation;
...
public class ExistingPasswordVerifyOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(ExistingPasswordVerifyOperation.class);
		 ...
		 Result result = new Result();
	        try {
	        	 UserManagementResource userManagementResource = DBPAPIAbstractFactoryImpl.getInstance()
		           ...
		           result = userManagementResource.verifyExistingPassword(methodID, inputArray, request, response);
	        } catch (Exception e) {
