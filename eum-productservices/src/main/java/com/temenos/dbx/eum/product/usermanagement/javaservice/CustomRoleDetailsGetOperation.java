...
import com.temenos.dbx.eum.product.usermanagement.javaservice.CustomRoleDetailsGetOperation;
...
public class CustomRoleDetailsGetOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(CustomRoleDetailsGetOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = customRoleResource.getCustomRole(methodID, inputArray, request, response);
		}
		catch (Exception exp) {
