...
import com.temenos.dbx.eum.product.usermanagement.javaservice.GetCustomRoleByCompanyIDOperation;
...
public class GetCustomRoleByCompanyIDOperation implements JavaService2{
	...
	private static final Logger LOG = LogManager.getLogger(GetCustomRoleByCompanyIDOperation.class);
