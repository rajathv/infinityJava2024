...
import com.temenos.dbx.eum.product.usermanagement.javaservice.CustomerP2PActivationOperation;
...
public class CustomerP2PActivationOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(CustomerP2PActivationOperation.class);
		 ...
		 Result result = new Result();
	        try {
	            ...
	            result = customerPreferenceResource.activateP2P(methodID, inputArray, request, response);
	        } catch (Exception e) {
