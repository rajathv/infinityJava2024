...
public class AddNewFeaturestoContractOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(AddNewFeaturestoContractOperation.class);
		 ...
		 Result result = new Result();
	        try {
	            ...
	            result = limitsAndPermissionsResource.addFeaturesAndActions(methodID, inputArray, request, response);
	        } catch (Exception e) {
