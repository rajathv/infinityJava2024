...
public class ContractFeatureActionsBackendDelegateImpl implements ContractFeatureActionsBackendDelegate {
	...
	private static final Logger LOG = LogManager.getLogger(
			ContractFeatureActionsBackendDelegateImpl.class);
    ...
    public Set<String> createContractFeatures(Set<String> featuresList, String contractId, String customerId,
        ...
        try {
        	...
        	LOG.error("contract features create failed", e);
    ...
    public void createContractActionLimits(StringBuilder queryString, Map<String, Object> headersMap)
        ...
        try {
            ...
            {
            	 inputParams = new HashMap<>();
            	inputParams.put("_queryInput", queryString.toString());
    ...
    public String getActionsWithApproveFeatureAction(String actionsCSV, String legalEntityId, Map<String, Object> headersMap)
        ...
        try {
            ...
            inputParams.put("_companyLegalUnit", !StringUtils.isBlank(legalEntityId) ? legalEntityId : "");
