...
import com.temenos.dbx.eum.product.usermanagement.javaservice.PINDeleteOperation;
...
public class PINDeleteOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(PINDeleteOperation.class);
