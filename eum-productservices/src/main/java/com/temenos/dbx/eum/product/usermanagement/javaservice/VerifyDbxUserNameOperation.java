...
import com.temenos.dbx.eum.product.usermanagement.javaservice.VerifyDbxUserNameOperation;
import com.temenos.dbx.eum.product.usermanagement.resource.api.UserManagementResource;

public class VerifyDbxUserNameOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(VerifyDbxUserNameOperation.class);
		 ...
		 Result result = new Result();
	        try {
	            ...
	            result = managementResource.getUserName(methodID, inputArray, request, response);
	        } catch (Exception e) {
