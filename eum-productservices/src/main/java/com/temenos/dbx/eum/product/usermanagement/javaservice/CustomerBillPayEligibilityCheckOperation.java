...
import com.temenos.dbx.eum.product.usermanagement.javaservice.CustomerBillPayEligibilityCheckOperation;
...
public class CustomerBillPayEligibilityCheckOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(CustomerBillPayEligibilityCheckOperation.class);
		 ...
		 Result result = new Result();
	        try {
	            ...
	            result = customerPreferenceResource.getisP2pActivated(methodID, inputArray, request, response);
	        } catch (Exception e) {
