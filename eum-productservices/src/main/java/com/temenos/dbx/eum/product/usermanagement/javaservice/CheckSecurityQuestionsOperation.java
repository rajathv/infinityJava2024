...
import com.temenos.dbx.eum.product.usermanagement.javaservice.CheckSecurityQuestionsOperation;
...
public class CheckSecurityQuestionsOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(CheckSecurityQuestionsOperation.class);
		 ...
		 Result result = new Result();
	        try {
	            ...
	            result = userManagementResource.checkSecurityQuestions(methodID, inputArray, request, response);
	        } catch (Exception e) {
