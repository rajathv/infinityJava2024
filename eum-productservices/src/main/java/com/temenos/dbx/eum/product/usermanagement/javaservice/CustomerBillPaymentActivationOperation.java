...
import com.temenos.dbx.eum.product.usermanagement.javaservice.CustomerBillPaymentActivationOperation;
...
public class CustomerBillPaymentActivationOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(CustomerBillPaymentActivationOperation.class);
		 ...
		 Result result = new Result();
	        try {
	            ...
	            result = customerPreferenceResource.activateBillPay(methodID, inputArray, request, response);
	        } catch (Exception e) {
