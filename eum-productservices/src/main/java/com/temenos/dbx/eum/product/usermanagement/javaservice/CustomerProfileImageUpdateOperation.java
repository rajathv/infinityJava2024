...
import com.temenos.dbx.eum.product.usermanagement.javaservice.CustomerProfileImageUpdateOperation;
import com.temenos.dbx.eum.product.usermanagement.resource.api.CustomerImageResource;

public class CustomerProfileImageUpdateOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(CustomerProfileImageUpdateOperation.class);
