...
import com.temenos.dbx.eum.product.usermanagement.javaservice.PreferrredBillPayAccountUpdateOperation;
...
public class PreferrredBillPayAccountUpdateOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(PreferrredBillPayAccountUpdateOperation.class);
		 ...
		 Result result = new Result();
	        try {
	            ...
	            result = customerPreferenceResource.updateCustomerPreference(methodID, inputArray, request, response);
	        } catch (Exception e) {
