...
public class CoreCustomerResourceImpl implements CoreCustomerResource {
    ...
    private static final String LEGALENTITY_ID = "legalEntityId";
    ...
    public Result searchCoreCustomers(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
        ...
        String legalEntityId =
                inputParams.get(LEGALENTITY_ID);
        ...
        if ((StringUtils.isBlank(coreCustomerId) && StringUtils.isBlank(customerName)
                ...
                && StringUtils.isBlank(city) && StringUtils.isBlank(zipCode) && StringUtils.isNotBlank(legalEntityId))
    ...
    public Result getCoreRelativeCustomers(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
        ...
        String coreCustomerId =
                inputParams.get(CORE_CUSTOMER_ID);
        String legalEntityId =
                StringUtils.isNotBlank(inputParams.get(LEGALENTITY_ID))? inputParams.get(LEGALENTITY_ID)
                		:dcRequest.getParameter(LEGALENTITY_ID);
    ...
    public Result getCoreCustomerAccounts(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
        ...
        String lgalEntityId = StringUtils.isNotBlank(inputParams.get(InfinityConstants.legalEntityId)) ? inputParams.get(InfinityConstants.legalEntityId)
				: dcRequest.getParameter(InfinityConstants.legalEntityId);
        
        if (StringUtils.isBlank(coreCustomerIdList)
        		|| StringUtils.isBlank(lgalEntityId)) {
        ...
        try {
            CoreCustomerBusinessDelegate businessDelegate =
                    DBPAPIAbstractFactoryImpl.getBusinessDelegate(CoreCustomerBusinessDelegate.class);
            response = businessDelegate.getCoreCustomerAccounts(coreCustomerIdList, lgalEntityId, dcRequest.getHeaderMap());
            if (response != null && response.getResponse() != null) {
                result = ConvertJsonToResult.convert((JsonObject) response.getResponse());
            }
        } catch (ApplicationException e) {
    ...
    public Result checkCoreRelativeCustomerForCompany(String methodID, Object[] inputArray,
        ...
        final String INPUT_LEGALENTITYID = "legalEntityId";
        ...
        try {
            ...
            /* business self enrollment*/
            String legalEntityId = StringUtils.isNotBlank(inputParams.get(INPUT_LEGALENTITYID)) ? inputParams.get(INPUT_LEGALENTITYID)
    				: dcRequest.getParameter(INPUT_LEGALENTITYID);

            CoreCustomerBusinessDelegate coreCustomerBusinessDelegate =
                    DBPAPIAbstractFactoryImpl.getBusinessDelegate(CoreCustomerBusinessDelegate.class);

            if ((StringUtils.isNotBlank(firstName) && StringUtils.isNotBlank(lastName)
                    && StringUtils.isNotBlank(dateOfBirth) && StringUtils.isNotBlank(ssn) && StringUtils.isNotBlank(legalEntityId))) {
                ...
                if (StringUtils.isNotBlank(cif)) {
                    relativeCustomersList =
                            coreCustomerBusinessDelegate.getCoreRelativeCustomers(cif, legalEntityId, dcRequest.getHeaderMap());
                    ...
                    companyDetailsDTO.setCompanyLegalUnit(legalEntityId);
        ...
        if (null == dto) {
            ...
            boolean status =
                    coreCustomerBD.checkIfTheCoreCustomerIsEnrolled(companyDetailsDTO.getId(),
                    		companyDetailsDTO.getCompanyLegalUnit(), dcRequest.getHeaderMap());
