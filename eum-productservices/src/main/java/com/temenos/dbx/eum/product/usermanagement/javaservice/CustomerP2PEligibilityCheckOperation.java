...
import com.temenos.dbx.eum.product.usermanagement.javaservice.CustomerP2PEligibilityCheckOperation;
...
public class CustomerP2PEligibilityCheckOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		logger = new LoggerUtil(CustomerP2PEligibilityCheckOperation.class);
		 ...
		 Result result = new Result();
	        try {
	            ...
	            result = customerPreferenceResource.checkBillPayEligibilityForUser(methodID, inputArray, request, response);
	        } catch (Exception e) {
