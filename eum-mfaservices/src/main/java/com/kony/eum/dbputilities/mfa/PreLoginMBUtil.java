...
public class PreLoginMBUtil {
    private static final Logger LOG = LogManager.getLogger(PreLoginMBUtil.class);
    ...
    public PreLoginMBUtil(DataControllerRequest dcRequest) {
    ...
    public PreLoginMBUtil(FabricRequestManager requestManager, String serviceKey, String serviceKeyGeneratedTime) {
    ...
    public PreLoginMBUtil(FabricRequestManager requestManager, String serviceKey) {
    ...
    public boolean configureMFA() {
        ...
        } else if (mfaConf.getNameOfAllParams().contains("errmsg")) {
    ...
    public JsonObject requestOTP(JsonObject OTP, JsonObject resultJson, boolean isCheckNeeded) {
        ...
        if (isPhoneValid || isEmailValid) {
            ...
            result = HelperMethods.callApi(requestManager, map,
                    HelperMethods.getHeadersWithReportingParams(requestManager),
                    URLConstants.REQUEST_PRELOGIN_OTP_REGISTERMB);
    ...
    public JsonObject getRequestPayload(String serviceKey, String serviceName) {
        ...
        if (requestManager != null) {
            if (StringUtils.isNotBlank(orgId)) {
                filter += DBPUtilitiesConstants.AND + "User_id" + DBPUtilitiesConstants.EQUAL + orgId;
            }
    ...
    public boolean isValidOnlyServiceKey() {
        Result result = new Result();
        String filter = MFAConstants.SERVICE_KEY + DBPUtilitiesConstants.EQUAL + serviceKey + DBPUtilitiesConstants.AND
                + MFAConstants.SERVICE_NAME + DBPUtilitiesConstants.EQUAL + serviceName;
        try {
