...
import static com.temenos.infinity.api.accountsweeps.utils.AccountSweepsAPIServices.DB_UPDATEACCOUNTSWEEP;

/**
 * @author naveen.yerra
 */
public class UpdateSweepAtBackend  implements JavaService2 {
    @Override
    public Object invoke(String s, Object[] objects, DataControllerRequest dataControllerRequest,
                         DataControllerResponse dataControllerResponse) throws Exception {
        String serviceName = DB_UPDATEACCOUNTSWEEP.getServiceName(),
                operationName = DB_UPDATEACCOUNTSWEEP.getOperationName();
