...
public class CreateStandingOrderWithoutApprover implements JavaService2 {
    @Override
    public Object invoke(String s, Object[] inputArray, DataControllerRequest request,
                         DataControllerResponse dataControllerResponse) throws Exception {
        Result result;
        String serviceName = ServiceId.SRMSBACKEND_STANDINGORDER_INTEGRATIONSERVICE;
        String operationName = OperationName.CREATE_STANDINGORDER_WITHOUTAPPROVER;
