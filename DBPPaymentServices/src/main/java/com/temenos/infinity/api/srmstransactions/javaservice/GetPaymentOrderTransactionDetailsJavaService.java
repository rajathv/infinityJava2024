...
public class GetPaymentOrderTransactionDetailsJavaService implements JavaService2 {
    @Override
    public Object invoke(String s, Object[] inputArray, DataControllerRequest request,
        ...
        String operationName = OperationName.GET_PAYMENTORDER_TRANSACTIONDETAILS;
