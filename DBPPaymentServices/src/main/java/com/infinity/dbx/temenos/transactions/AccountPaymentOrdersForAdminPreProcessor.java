...
public class AccountPaymentOrdersForAdminPreProcessor extends TemenosBasePreProcessor {

	private static final Logger logger = LogManager.getLogger(AccountPaymentOrdersForAdminPreProcessor.class);
