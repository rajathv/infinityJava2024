...
public class PendingTransactionsForAdminPreProcessor extends TemenosBasePreProcessor {

	private static final Logger logger = LogManager.getLogger(PendingTransactionsForAdminPreProcessor.class);
