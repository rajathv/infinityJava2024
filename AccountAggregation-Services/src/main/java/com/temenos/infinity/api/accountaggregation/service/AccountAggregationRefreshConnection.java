...
public class AccountAggregationRefreshConnection implements JavaService2 {
    ...
    public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
        ...
        Result result = customerResource.refreshConnection(request.getParameter("digitalProfileId"),
