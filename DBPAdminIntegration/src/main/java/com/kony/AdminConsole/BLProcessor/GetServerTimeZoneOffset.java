...
public class GetServerTimeZoneOffset implements JavaService2 {

    @Override
    public Object invoke(String methodID, Object[] inputArray, DataControllerRequest requestInstance,
            DataControllerResponse responseInstance) throws Exception {
        JSONObject getResponse = getServerTimeZoneOffset(requestInstance);
        if (getResponse.getInt(DBPConstants.FABRIC_OPSTATUS_KEY) != 0) {
            ...
            getResponse = getServerTimeZoneOffset(requestInstance);
        }
    ...
    public JSONObject getServerTimeZoneOffset(DataControllerRequest dcRequest) {

        Map<String, Object> postParametersMap = new HashMap<>();
        String getResponseString = HelperMethods.invokeC360ServiceAndGetString(dcRequest, postParametersMap,
                new HashMap<>(), "getServerTimeZoneOffset");
