...
public class DeleteOutageMessage implements JavaService2 {
    ...
    public Object invoke(String methodID, Object[] inputArray, DataControllerRequest requestInstance,
        ...
        try {
            ...
            JSONObject getResponse = deleteOutageMessage(outageMessageIds, requestInstance);
            if (getResponse.getInt(DBPConstants.FABRIC_OPSTATUS_KEY) != 0) {
                ...
                getResponse = deleteOutageMessage(outageMessageIds, requestInstance);
            }
    ...
    public JSONObject deleteOutageMessage(JSONArray outageMessageIds, DataControllerRequest dcRequest) {
        ...
        String getResponseString = HelperMethods.invokeC360ServiceAndGetString(dcRequest, postParametersMap,
                new HashMap<>(), "deleteOutageMessage");
