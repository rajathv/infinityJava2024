...
import com.temenos.infinity.api.chequemanagement.utils.GetChequeTypeMock;


public class GetChequeTypePreProcessor implements ObjectServicePreProcessor {
	...
	public void execute(FabricRequestManager fabricRequestManager, FabricResponseManager fabricResponseManager, FabricRequestChain fabricRequestChain) throws Exception {
        ...
        Class<? extends ObjectProcessorTask>[] tasks = new Class[]{GetChequeTypeMock.class};
