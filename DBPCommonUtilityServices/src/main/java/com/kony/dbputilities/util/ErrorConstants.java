...
public class ErrorConstants {
    ...
    public static final String VALIDATE_FOR_APPROVALS_INVALID_BACKEND_RESPONSE = "Invalid response received from Validate for Approvals";
    public static final String BACKEND_FAILED_BBREQUEST_GET = "Failed to fetch transactions from bbrequest";
    public static final String PENDING_TRANSACTION_FOR_PAYEE = "Invalid Request! Existing Pending Transaction for the Payee";
    public static final String INVALID_INPUT_FOR_EDIT_BENEFICIARY = "Invalid Request! At a given time only Optional fields or Linkage Can be edited";
    public static final String BENEFICIARY_DATA_NOT_UPDATED = "Beneficiary Fields have not been updated";
    public static final String COMPANYCODE_DOSENT_BELONG_TO_THE_LOGGEDIN_USER = "Company code does not belong to the logged in user";
    ...
    public static final String INVALID_ATTACHMENT_LENGTH =
            "Incorrect file name. Please upload file name length should be less than 150 characters.";
    
    public static final String INVALID_LEGAL_ENTITY_CUSTOMER =
            "Customer with this legal enity cannot be added to user, since customer alreay exists.";
    ...
    public static final String CANNOT_APPROVE_ILLEGAL_STATE = "Cannot Approve the Transaction as it is not in Pending state";
    public static final String CANNOT_APPROVE_APPROVED = "This Transaction is already Approved or Executed.";
	...
	public static final String DENIED_ACTIONID_ACCESS_TO_CIF = "The core customer does not have access to given actionId";
	public static final String DENIED_ACTIONID_ACCESS_TO_ACCOUNT = "The given accountId does not have access to the given actionId";
 ...
 // Cheque Management Codes
	...
	public static final String MAX_PERIOD_EXCEEDED = "Max target period exceeded";

    public static final String MISSING_TEMPLATE_DESCRIPTION = "TemplateDescription is missing in the input. please provide valid TemplateDescription.";
    public static final String INVALID_RECORD_NAME = "Please provide valid Record Name.";
}
