...
public enum ErrorCodeEnum {
    ...
    ERR_10100(10100, "spotlight service Failed"),
    ERR_10021(10021, "Something went wrong while serving the request"),
    ...
    ERR_87101(87101, "Contract ID is a mandatory field!"),
    ...
    ERR_10420(10420, "Invalid Limits"),
    ...
    ERR_10813(10813, "Failed to core customer details"),
    ...
    ERR_10815(10815, "Failed to fetch permissions"),
    ERR_10816(10816, "Failed to fetch service definition permissions"),
    ERR_10817(10817, "Failed to fetch product level permissions"),
    ERR_10818(10818, "Failed to fetch contract actions"),
    ERR_10819(10818, "Failed to edit user"),
    ERR_10820(10820, "Backend failed to get user attributes"),
    ERR_10821(10821, "Failed to update language Info"),
    ...
    ERR_12291(12291, "ACH Transaction does not exist for the given customer"),
    ...
    ERR_12311(12311, "File contains multiple extentions"),
    ...
    ERR_12465(12465, ErrorConstants.INVALID_ATTACHMENT_LENGTH),
    ERR_12466(12466, ErrorConstants.INVALID_LEGAL_ENTITY_CUSTOMER),
    ...
    ERR_12612(12612, ErrorConstants.BACKEND_FAILED_BBREQUEST_GET),

    ERR_12613(12613, ErrorConstants.PENDING_TRANSACTION_FOR_PAYEE),

    ERR_12614(12614, ErrorConstants.INVALID_INPUT_FOR_EDIT_BENEFICIARY),

    ERR_12615(12615, ErrorConstants.BENEFICIARY_DATA_NOT_UPDATED),
    ...
    ERR_21039(21039, ErrorConstants.CANNOT_APPROVE_APPROVED),
    ERR_21040(21040, ErrorConstants.CANNOT_APPROVE_ILLEGAL_STATE),
    ...
    ERR_21243(21243, ErrorConstants.DENIED_ACTIONID_ACCESS_TO_CIF),
    ERR_21244(21244, ErrorConstants.DENIED_ACTIONID_ACCESS_TO_ACCOUNT),
    ...
    ERR_20049(20049, ErrorConstants.INVALID_PAYLOAD),
    ERR_20050(20050, ErrorConstants.MAX_PERIOD_EXCEEDED),
    ...
    ERR_26024(26024, ErrorConstants.VALIDATE_FOR_APPROVALS_INVALID_BACKEND_RESPONSE),
    ...
    ERR_29037(29037, "Clause already exists."),
    ERR_29034(29034, ErrorConstants.ERROR_WHILE_GENERATING_JWT_TOKEN),
    ERR_29035(29035, "Beneficiary is linked with more than one guarantee, we can't edit this from here"),
    ERR_29036(29036, ErrorConstants.MISSING_TEMPLATE_DESCRIPTION),
    ERR_29038(29038, ErrorConstants.INVALID_RECORD_NAME),
	ERR_29039(29039, "Failed to fetch core customer product action limits"),
	ERR_29040(29040, "Legal Entity Id cannot be empty!"),
	ERR_29041(29041, "Error while searching the customer"),
	ERR_29042(29042, "Failed to validate user details!"),
	ERR_29043(29043, "Failed to validate global level permission details!"),
    ERR_29050(29050, "Please Provide a valid SSN Number of the user."),
    ERR_29051(29051, "Legal Entity not found for the given core customer ID and contract ID!"),
    ERR_29052(29052, "Error while fetching legal entity information from db service!"),
	ERR_29053(29053, "Improper default service defition data"),
	ERR_29055(29055, "The logged in customer has no active legal entity"),
	ERR_29054(29054, "Error in getting customer legal entities."),
	ERR_29056(29056, "Error in getting customer legal entities."),
	ERR_29057(29057, "Profile already exists for given customer!"),
	ERR_29058(29058, "Account closure is not valid for this account type"),
	ERR_29059(29042, "Invalid input payload!"),
	ERR_29061(29061, "Get Asset Liabilities failed"),
	ERR_29062(29062, "Failed to get terms and conditions"),
	ERR_29063(29063, "Failed to get Terms and Conditions text"),
	ERR_29060(29060, "Get Source Of Funds failed"),
    ERR_29064(29064, ErrorConstants.COMPANYCODE_DOSENT_BELONG_TO_THE_LOGGEDIN_USER),
    ERR_87102(87102, "Core Customer ID is a mandatory field!"),
    ERR_87103(87103, "Feature Action ID is a mandatory field!"),
    ERR_87104(87104, "Invalid value for Feature Action ID!"),
    ERR_87105(87105, "Limit Type ID is a mandatory field!"),
    ERR_87106(87106, "Invalid value for Limit Type ID!"),
    ERR_87107(87107, "Approval Rule Initialization Failed - Limit Ranges - invalid lowerLimit value!"),
    ERR_87108(87108, "Approval Rule Initialization Failed - Limit Ranges - invalid upperLimit value!"),
    ERR_87109(87109, "Approval Rule Initialization Failed - Limit Ranges - groupRule field missing!"),
    ERR_87110(87110, "Approval Rule Initialization Failed - Limit Ranges - approvers field missing!"),
    ERR_87111(87111, "Approval Rule Initialization Failed- Limit Ranges - invalid approvers value!"),
    ERR_87112(87112, "Approval Rule Initialization Failed - limit ranges missing!"),
    ERR_87113(87113, "Approval Rule Initialization Failed - invalid format for limit ranges payload!"),
    ERR_87114(87114, "Approval Rule Initialization Failed - invalid values for limit ranges!"),
    ERR_87115(87115, "Approval Rule Initialization Failed - Limit Ranges - Invalid approvers information!"),
    ERR_87116(87116, "Failed to update the approval mode!"),
    ERR_87199(87199, "Approval Rule Initialization - Failed to create/update approval rule!"),
    ERR_87200(87200, "Approvals Validation - featureActionId field missing!"),
    ERR_87201(87201, "Approvals Validation - invalid featureActionId passed!"),
    ERR_87202(87202, "Approvals Validation - confirmation id missing!"),
    ERR_87203(87203, "Approvals Validation - customerId missing!"),
    ERR_87204(87204, "Approvals Validation - amount is a mandatory field for a monetary action!"),
    ERR_87205(87205, "Approvals Validation - invalid amount passed!"),
    ERR_87206(87206, "Approvals Validation - status field missing or invalid status passed!"),
    ERR_87207(87207, "Approvals Validation - accountId is a mandatory field for an account-level action!"),
    ERR_87208(87208, "Approvals Validation - contractCifMap is a mandatory field for a customer-level action!"),
    ERR_87209(87209, "Approvals Validation - invalid format for contractCifMap passed!"),
    ERR_87210(87210, "Approvals Validation - date is a mandatory field for an account-level action!"),
    ERR_87211(87211, "Approvals Validation - transaction currency is a mandatory field for an account-level action!"),
    ERR_87212(87212, "Approvals Validation - Invalid upper limit or lower limit identified!"),
    ERR_87213(87213, "Error while fetching approval rules from DBXDB!"),
    ERR_87214(87214, "No entries found for approval mode for the given set of contract ID's and core customer ID's"),
    ERR_87215(87215, "No entries found for the approval matrix status for the given set of contract ID's and core customer ID's"),
    ERR_87301(87301, "Limits Validation For Approvals - Unable to fetch customer's master limits!"),
    ERR_87302(87302, "Limits Validation For Approvals - Unable to fetch contract-level limits!"),
    ERR_87303(87303, "Limits Validation For Approvals - Unable to fetch role-level limits!"),
    ERR_87304(87304, "Limits Validation For Approvals - Unable to fetch limit-group-level limits!"),
    ERR_87305(87305, "Limits Validation For Approvals - Unable to fetch customer-level limits!"),
    ERR_87306(87306, "Limits Validation For Approvals - Unable to fetch customer-level limits for the stated accountId!"),
    ERR_87307(87307, "Limits Validation For Approvals - Unable to fetch role id for the customer!"),
    ERR_87308(87308, "Limits Validation For Approvals - Unable to fetch limit-group id for the customer!"),
    ERR_87309(87309, "Limits Validation For Approvals - Exceeded Per Transaction limit at the contract-level!"),
    ERR_87310(87310, "Limits Validation For Approvals - Exceeded Daily limit at the contract-level!"),
    ERR_87311(87311, "Limits Validation For Approvals - Exceeded Weekly limits at the contract-level!"),
    ERR_87312(87312, "Limits Validation For Approvals - Exceeded Per Transaction limit at the role-level!"),
    ERR_87313(87313, "Limits Validation For Approvals - Exceeded Daily limit at the role-level!"),
    ERR_87314(87314, "Limits Validation For Approvals - Exceeded Weekly limits at the role-level!"),
    ERR_87315(87315, "Limits Validation For Approvals - Exceeded Per Transaction limit at the limit-group-level!"),
    ERR_87316(87316, "Limits Validation For Approvals - Exceeded Daily limit at the limit-group-level!"),
    ERR_87317(87317, "Limits Validation For Approvals - Exceeded Weekly limits at the limit-group-level!"),
    ERR_87318(87312, "Limits Validation For Approvals - Exceeded Per Transaction limit at the limit group-level!"),
    ERR_87319(87313, "Limits Validation For Approvals - Exceeded Daily limit at the limit group-level!"),
    ERR_87320(87314, "Limits Validation For Approvals - Exceeded Weekly limits at the limit group-level!"),
    ERR_87321(87315, "Limits Validation For Approvals - Unable to fetch role id for the customer!"),
    ERR_87400(87400, "No such request found associated with the customer for the given request id"),
    ERR_87401(87401, "User is not eligible to act on the given set of requests"),
    ERR_87402(87402, "Request ID field is a mandatory field, and cannot be blank!"),
    ERR_87403(87403, "You can act on only one request at a time for the moment!"),
    ERR_87404(87404, "Failed to create new requests at DBX!"),
    ERR_87405(87405, "Failed to approve requests at DBX!"),
    ERR_87406(87406, "Failed to reject requests at DBX!"),
    ERR_87407(87407, "Failed to withdraw requests a DBX!"),

    ERR_87420(87420, "Internal Approvals Framework Error");
