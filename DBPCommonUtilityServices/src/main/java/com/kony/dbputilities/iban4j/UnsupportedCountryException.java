...
public class UnsupportedCountryException extends Iban4jException {
    ...
    /**
     * Constructs a <code>UnsupportedCountryException</code> with the specified country code and detail message.
     *
     * @param countryCode
     *            the country code.
     * @param s
    ...
    /**
     * Constructs a <code>UnsupportedCountryException</code> with the specified detail message and cause.
     *
     * @param s
     *            the detail message.
     * @param t
