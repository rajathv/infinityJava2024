...
public class InvalidCheckDigitException extends Iban4jException {
    ...
    /**
     * Constructs a <code>InvalidCheckDigitException</code> with the specified actual, expected and detail message.
     *
     * @param actual
     *            the actual check digit.
     * @param expected
    ...
    /**
     * Constructs a <code>InvalidCheckDigitException</code> with the specified detail message and cause.
     *
     * @param s
     *            the detail message.
     * @param t
