...
import static com.kony.dbputilities.iban4j.IbanFormatException.IbanFormatViolation.ACCOUNT_NUMBER_NOT_NULL;
import static com.kony.dbputilities.iban4j.IbanFormatException.IbanFormatViolation.BANK_CODE_NOT_NULL;
import static com.kony.dbputilities.iban4j.IbanFormatException.IbanFormatViolation.COUNTRY_CODE_NOT_NULL;
...
public final class Iban {
     ...
     *             if the String doesn't contain parsable Iban InvalidCheckDigitException if Iban has invalid check
     *             digit UnsupportedCountryException if Iban's Country is not supported.
     *
     */
        ...
        switch (format) {
            case Default:
                ...
                throw new IbanFormatException(IBAN_FORMATTING, String.format(
                        "Iban must be formatted using 4 characters and space combination. " + "Instead of [%s]", iban));
            default:
                return valueOf(iban);
        }
    }
