...
/**
 * Thrown to indicate that the application has attempted to convert a string to Bic or to validate Bic's string
 * representation, but the string does not have the appropriate format.
 */
public class BicFormatException extends Iban4jException {
    ...
    /**
     * Constructs a <code>BicFormatException</code> with the specified violation, actual value, expected value and
     * detail message.
     *
     * @param violation
     *            the violation.
    ...
    /**
     * Constructs a <code>BicFormatException</code> with the specified violation, actual value and detail message.
     *
     * @param violation
     *            the violation.
     * @param actual
    ...
    public enum BicFormatViolation {
        ...
        BIC_NOT_NULL, BIC_NOT_EMPTY, BIC_LENGTH_8_OR_11, BIC_ONLY_UPPER_CASE_LETTERS,

        BRANCH_CODE_ONLY_LETTERS_OR_DIGITS, LOCATION_CODE_ONLY_LETTERS_OR_DIGITS, BANK_CODE_ONLY_LETTERS,
