...
public class MortgageFacilityDrawingOperation implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(MortgageFacilityDrawingOperation.class);
    ...
    public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
        ...
        try {
        	String methodId="";
        	MortgageFacilityDrawingsResource mortageDrwaingsResource =
                    DBPAPIAbstractFactoryImpl.getResource(MortgageFacilityDrawingsResource.class);
            result = mortageDrwaingsResource.getMortageFacilityDrawing(methodId, inputArray, request, response);
