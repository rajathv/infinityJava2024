...
public class SubmitChangeRepaymentDayServiceRequestOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(SubmitChangeRepaymentDayServiceRequestOperation.class);
	@Override
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			MortgageRepaymentDTO changeRepaymentday = constructPayLoad(request);
			...
			headerMap.put("companyid", companyid);
			 result = submitChangeRepaymentResource.SubmitChangeRepaymentDay(changeRepaymentday, request,headerMap);
			return result;
		} catch (Exception e) {
	...
	public static MortgageRepaymentDTO constructPayLoad(DataControllerRequest request) {
		MortgageRepaymentDTO changeRepaymentday = new MortgageRepaymentDTO();
		...
		String currentMaturityDate = request.getParameter("currentMaturityDate") != null ? request.getParameter("currentMaturityDate") : "";
		...
		changeRepaymentday.setFacilityName(facilityName);
		changeRepaymentday.setArrangementId(arrangementId);
		changeRepaymentday.setCustomerName(customerName);
		changeRepaymentday.setNumOfLoans(numOfLoans);
		changeRepaymentday.setCurrentOutstandingBalanceCurrency(currentOutstandingBalanceCurrency);
		changeRepaymentday.setCurrentOutstandingBalanceAmount(currentOutstandingBalanceAmount);
		changeRepaymentday.setCurrentMaturityDate(currentMaturityDate);
		changeRepaymentday.setSupportingDocumentIds(supportingDocumentIds);
		changeRepaymentday.setRequestDetails(requestDetails);
		changeRepaymentday.setAccountId(accountId);
		changeRepaymentday.setCustomerId(customerId);
