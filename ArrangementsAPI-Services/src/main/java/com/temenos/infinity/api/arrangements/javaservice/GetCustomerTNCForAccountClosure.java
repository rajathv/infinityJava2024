...
public class GetCustomerTNCForAccountClosure implements JavaService2 {
	
	private static final Logger LOG = LogManager.getLogger(GetCustomerTNCForAccountClosure.class);
    @Override
    public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
        ...
        LOG.error("termsAndConditionsFromAdmin response 1" +termsAndConditionsFromAdmin);
