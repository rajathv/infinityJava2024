...
public class FetchChequeDetailsOperation implements JavaService2{
	private static final Logger LOG = LogManager.getLogger(FetchChequeDetailsOperation.class);
	...
	public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			Result result =  chequeManagementResource.fetchChequeDetails(request);
			return result;
		}
		catch (Exception e) { 
			LOG.error(e);
