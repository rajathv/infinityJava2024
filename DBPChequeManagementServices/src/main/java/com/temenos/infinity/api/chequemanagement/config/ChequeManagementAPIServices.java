...
public enum ChequeManagementAPIServices implements InfinityServices {
    ...
    T24TRANSACT_CREATECHEQUEBOOK("T24ISStopPayments","createChequeBookRequests"),
    T24TRANSACT_CREATESTOPPAYMENT("T24ISExtra","createStopChequePayments"),
	T24TRANSACT_REVOKESTOPPAYMENT("T24ISExtra","revokeStopChequePayments"),
