...
public class CancelBulkPaymentRecordOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(CancelBulkPaymentRecordOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = bulkPaymentRecordResource.cancelBulkPaymentRecord(methodID, inputArray, request, response);
		}
		catch(Exception e) {
