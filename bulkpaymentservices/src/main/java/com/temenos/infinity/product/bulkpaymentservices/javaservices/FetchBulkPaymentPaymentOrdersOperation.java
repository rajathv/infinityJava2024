...
public class FetchBulkPaymentPaymentOrdersOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(FetchBulkPaymentPaymentOrdersOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = bulkPaymentPOResource.fetchPaymentOrders(methodID, inputArray, request, response);
		} catch (Exception e) {
