...
public class FetchBulkPaymentHistoryOperation implements JavaService2{
	
	private static final Logger LOG = LogManager.getLogger(FetchBulkPaymentHistoryOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result = bulkPaymentRecordResource.fetchBulkPaymentHistory(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Error occured while invoking fetchBulkPaymentHistory: ", e);
