...
import com.temenos.infinity.product.bulkpaymentservices.validations.PaymentOrderIdValidation;

public class FetchPaymentOrderPreProcessor implements ObjectServicePreProcessor {
    @Override
    public void execute(FabricRequestManager fabricRequestManager, FabricResponseManager fabricResponseManager, FabricRequestChain fabricRequestChain) throws Exception {
        ...
        Class<? extends ObjectProcessorTask>[] tasks = new Class[]{PaymentOrderIdValidation.class};
