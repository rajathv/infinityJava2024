...
public class CardUpdateMFAFlowTestPreProcessor implements ObjectServicePreProcessor {
	private static  Logger LOG = LogManager.getLogger(CardUpdateMFAFlowTestPreProcessor.class);
	...
	public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager,
		...
		new CardUpdateMFAPreProcessor().execute(requestManager, responseManager, requestChain);
