...
import com.kony.dbputilities.mfa.preprocessors.PasswordUpdateMFAPreProcessor;
...
public class PasswordUpdateMFAFlowTestPreProcessor implements ObjectServicePreProcessor {
	private static  Logger LOG = LogManager.getLogger(PasswordUpdateMFAFlowTestPreProcessor.class);
	...
	public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager,
		...
		new PasswordUpdateMFAPreProcessor().execute(requestManager, responseManager, requestChain);
