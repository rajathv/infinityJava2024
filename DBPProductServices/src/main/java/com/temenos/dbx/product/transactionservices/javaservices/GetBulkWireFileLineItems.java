 ...
 * @author KH2301
 * @version 1.0
 * Java Service end point to fetch all the Bulk Wire File Transfer Details
 */
public class GetBulkWireFileLineItems implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetBulkWireFileLineItems.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = bulkWireFileResource.getBulkWireFileLineItems(methodID, inputArray, request, response);
		}
		catch(Exception e) {
