...
// This source was moved to DocumentManagement java project
		...
		try {
			...
			for (Object individualAccountIdObj : accountList) {
				...
				JsonObject accountJsonObject = ServiceCallHelper.invokeServiceAndGetJson(accountsParam, accountHeaders,
						URLConstants.COMBINED_STATEMENT_ACCOUNT_DETAILS);
				String accountName = "";
			...
			//	transactionsParam.put("legalEntityId", HelperMethods.getLegalEntityId());
