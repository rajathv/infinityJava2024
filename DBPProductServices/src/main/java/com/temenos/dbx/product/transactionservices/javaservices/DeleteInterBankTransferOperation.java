 ...
 */
public class DeleteInterBankTransferOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(DeleteInterBankTransferOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = interBankTransactionResource.deleteTransaction(methodID, inputArray, request, response);
		}
		catch(Exception e) {
