...
public interface InterBankPayeeResource extends Resource {
    /**
    ...
    /**
     *  This method is invoked to edit an Inter bank payee contract-cif linkage after the approval request is approved
    ...
    /**
     *  This method is invoked to edit an Inter bank payee optional fields after the approval request is approved
     *  @author Subham Kumar Patel (21554)
     *
     *  @param request contains request handler
    ...
    /**
     *  This method deletes an Inter bank payee after the approval request is approved
     *  @author Subham Kumar Patel (21554)
     *
     *  @param request contains request handler
