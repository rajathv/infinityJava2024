...
public class FetchSignatoryGroupsOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(FetchSignatoryGroupsOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = signatoryGroupResource.fetchSignatoryGroups(methodID, inputArray, request, response);
		}
		catch(Exception e) {
