...
public class GetInterBankPayeeOperation implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(GetInterBankPayeeOperation.class);
    ...
    public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
        ...
        try {
            ...
            InterBankPayeeResource interBankPayeeResource = DBPAPIAbstractFactoryImpl.getInstance()
                    .getFactoryInstance(ResourceFactory.class).getResource(InterBankPayeeResource.class);;

            result  = interBankPayeeResource.fetchAllMyPayees(methodID, inputArray, request, response);
        }
        catch(Exception e) {
