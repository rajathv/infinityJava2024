...
public class InternationalPayeeDTO implements DBPDTO{
	...
	List<InternationalPayeeDTO> fileRecords;

	public InternationalPayeeDTO() {
		super();
	}

	public InternationalPayeeDTO(String id, String typeId, String payeeId, String createdBy, String contractId, String cif,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		InternationalPayeeDTO other = (InternationalPayeeDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
