...
public class UpdateIntraBankTransactionStatusAtDBXOperation implements JavaService2  {
	...
	private final static Logger LOG = LogManager.getLogger(UpdateIntraBankTransactionStatusAtDBXOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			LOG.error("Exception occured while updating intrabanktransaction",exp);
