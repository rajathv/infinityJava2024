...
public class FetchGeneralTransactionByIdOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(FetchGeneralTransactionByIdOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = generalTransactionResource.fetchGeneralTransactionById(methodID, inputArray, request, response);
		}
		catch(Exception e) {
