...
public class WithdrawRequestService implements JavaService2 {
    private static final Logger LOG = Logger.getLogger(WithdrawRequestService.class);
    @Override
    public Object invoke(String method, Object[] inputArray, DataControllerRequest dcRequest, DataControllerResponse dcResponse) throws Exception {
        ...
        try {
            result = approvalRequestResource.withdrawRequest(inputMap, dcRequest);
