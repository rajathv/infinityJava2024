...
public class ApproveGeneralTransaction implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(ApproveGeneralTransaction.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = approvalQueueResource.approveGeneralTransactionRequest(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of ApproveGeneralTransaction: "+e);
		}
