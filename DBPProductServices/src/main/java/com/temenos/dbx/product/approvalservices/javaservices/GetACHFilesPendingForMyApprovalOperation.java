 ...
 * @author KH2638
 * @version 1.0
 * Java Service end point to fetch ACH files pending for my approval
 * @param <ApprovalServiceResource>
 */

public class GetACHFilesPendingForMyApprovalOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = approvalResource.fetchACHFilesPendingForMyApproval(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of fetchACHFilesPendingForMyApproval: "+e);
