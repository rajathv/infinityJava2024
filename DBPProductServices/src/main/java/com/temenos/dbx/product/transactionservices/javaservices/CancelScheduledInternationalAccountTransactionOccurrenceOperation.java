 ...
 */
public class CancelScheduledInternationalAccountTransactionOccurrenceOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(CancelScheduledInternationalAccountTransactionOccurrenceOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = internationalTransactionResource.cancelScheduledTransactionOccurrence(methodID, inputArray, request, response);
		}
		catch(Exception e) {
