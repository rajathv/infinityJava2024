 ...
 * @author KH2638
 * @version 1.0
 * Java Service end point to create Bill Pay Payee
 */
public class CreateBillPayPayeeOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(CreateBillPayPayeeOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = billPayPayeeResource.createPayee(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of CreateBillPayPayeeOperation: ", e);
