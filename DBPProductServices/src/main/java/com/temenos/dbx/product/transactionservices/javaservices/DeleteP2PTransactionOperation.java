 ...
 */
public class DeleteP2PTransactionOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(DeleteP2PTransactionOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = p2pTransactionResource.deleteTransaction(methodID, inputArray, request, response);
		}
		catch(Exception e) {
