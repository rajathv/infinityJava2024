 ...
 * @author KH2638
 * @version 1.0
 * Java Service end point to fetch general transaction requests
 * @param <ApprovalServiceResource>
 */

public class GetGeneralTransactionRequestsOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetGeneralTransactionRequestsOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = approvalResource.fetchGeneralTransactionMyRequests(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of fetchGeneralTransactionRequests: "+e);
