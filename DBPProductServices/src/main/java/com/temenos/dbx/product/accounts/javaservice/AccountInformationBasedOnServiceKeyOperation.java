...
public class AccountInformationBasedOnServiceKeyOperation implements JavaService2 {
	LoggerUtil logger = new LoggerUtil(AccountInformationBasedOnServiceKeyOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = accountsResource.getAccountInformationBasedOnServicekey(methodID, inputArray, request, response);
