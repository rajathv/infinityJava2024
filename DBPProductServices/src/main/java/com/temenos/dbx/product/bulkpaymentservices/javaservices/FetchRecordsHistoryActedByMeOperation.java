...
private static final Logger LOG = LogManager.getLogger(FetchRecordsHistoryActedByMeOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			LOG.error("Error occured while invoking FetchRecordsHistoryActedByMeOperation: ", e);
