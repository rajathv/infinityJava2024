 ...
 */
public class CreateInternationalAccountTransferOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(CreateInternationalAccountTransferOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			transactionResult = internationalTransactionResource.createTransaction(methodID, inputArray, request,
					response);
			...
			LOG.error("Error occured while invoking CreateInternationalAccountTransferOperation: ", e);
