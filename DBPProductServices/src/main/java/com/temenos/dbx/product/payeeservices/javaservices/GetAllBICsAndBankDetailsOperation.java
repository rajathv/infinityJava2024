...
public class GetAllBICsAndBankDetailsOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(GetAllBICsAndBankDetailsOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {			
			...
			result = bulkPaymentsPayeeResource.getAllBICsAndBankDetails(methodID, inputArray, request, response);
		} catch (Exception e) {
