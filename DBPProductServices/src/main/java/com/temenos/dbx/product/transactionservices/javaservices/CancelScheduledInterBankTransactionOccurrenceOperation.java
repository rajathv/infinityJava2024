 ...
 */
public class CancelScheduledInterBankTransactionOccurrenceOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(CancelScheduledInterBankTransactionOccurrenceOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = interBankTransactionResource.cancelScheduledTransactionOccurrence(methodID, inputArray, request, response);
		}
		catch(Exception e) {
