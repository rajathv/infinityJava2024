...
public class UploadACHFileOperation implements JavaService2{
	
	private static final Logger LOG = LogManager.getLogger(UploadACHFileOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = achFileResource.uploadACHFile(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Error occured while invoking UploadACHFile: ", e);
