...
public class EditInternationalPayeeOperation implements JavaService2 {

    private static final Logger LOG = LogManager.getLogger(EditInternationalPayeeOperation.class);
