 ...
 * @author KH1755
 * @version 1.0
 * Java Service end point to get counts for Approvals and requests
 * @param <ApprovalServiceResource>
 */

public class GetApprovalRequestCountsOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetApprovalRequestCountsOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = approvalResource.getCounts(methodID, inputArray, request, response);
		}
		catch(Exception e) {
