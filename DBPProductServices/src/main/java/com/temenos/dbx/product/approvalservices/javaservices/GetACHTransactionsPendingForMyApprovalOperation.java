...
public class GetACHTransactionsPendingForMyApprovalOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = approvalResource.fetchACHTransactionsPendingForMyApproval(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of fetchACHTransactionsPendingForMyApproval: "+e);
