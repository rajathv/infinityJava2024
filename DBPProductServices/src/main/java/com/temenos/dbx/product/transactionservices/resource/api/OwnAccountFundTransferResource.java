...
public interface OwnAccountFundTransferResource extends Resource {

    /**
     * creates OwnAccount transaction after validating the limits and puts into approval queue if required
     * @param methodID
     * @param inputArray
     * @param request
     * @param response
	...
	**/
	...
	/** OwnAccountTranscation post processor this is hooked on the line of business service to 
    ...
    /**
     * Edits an own account fund transaction after validating the limits and puts into approval queue if required
     * @param methodID
     * @param inputArray
     * @param request
     * @param response
