...
public class CreateSignatoryGroup implements JavaService2 {
	...
	private static final Logger LOG = LogManager.getLogger(CreateSignatoryGroup.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = signatoryGroupResource.createSignatoryGroup(methodID, inputArray, request, response);
		}
		catch(Exception e) {
