 ...
 */
public class EditIntraBankTransferOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(EditIntraBankTransferOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = intraBankTranscationResource.editTransaction(methodID, inputArray, request, response);
			...
			LOG.error("Error occured while invoking EditIntraBankTransferOperation: ", e);
