...
public class DeleteSignatoryGroup implements JavaService2 {
	
	private static final Logger LOG = LogManager.getLogger(DeleteSignatoryGroup.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = signatoryGroupResource.deleteSignatoryGroup(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of DeleteSignatoryGroup: ", e);
