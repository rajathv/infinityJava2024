 ...
 * @author KH2638
 * @version 1.0
 * Java Service end point to fetch ach file requests
 * @param <ApprovalServiceResource>
 */

public class GetACHFileRequestsOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetACHFileRequestsOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = approvalResource.fetchACHFileMyRequests(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of fetchACHFileRequests: "+e);
