 ...
 */
public class CreateInterBankTransferOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(CreateInterBankTransferOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			transactionResult = interBankTransactionResource.createTransaction(methodID, inputArray, request, response);
			...
			LOG.error("Error occured while invoking CreateInterBankTransaction: ", e);
