 ...
 */
public class DeleteOwnAccountTransferOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(DeleteOwnAccountTransferOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = ownaccountTranscationResource.deleteTransaction(methodID, inputArray, request, response);
		}
		catch(Exception e) {
