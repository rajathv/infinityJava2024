...
public class EditInterBankPayeeOperation implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(EditInterBankPayeeOperation.class);
