...
public class InternationalWireTransferPostProcessor implements DataPostProcessor2 {
	
	private static final Logger LOG = LogManager.getLogger(InternationalWireTransferPostProcessor.class);
	...
	public Object execute(Result result, DataControllerRequest request, DataControllerResponse response)
		...
		try {
			...
			LOG.error("Error occured while invoking post processor for CreateInternationalWireTransaction: ", e);
