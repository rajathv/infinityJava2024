...
public class RejectBulkPaymentRecordOperation implements JavaService2{
	
	private static final Logger LOG = LogManager.getLogger(RejectBulkPaymentRecordOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, DataControllerResponse response) {
		...
		try {
			...
			result = bulkPaymentRecordResource.rejectBulkPaymentRecord(methodID, inputArray, request, response);
		}
		catch(Exception e) {
