...
public interface P2PTransactionResource extends Resource {

    /**
     * creates p2p transaction after validating the limits and puts into approval queue if required
     * @param methodID
     * @param inputArray
     * @param request
     * @param response
	...
	**/
	...
	/** P2PTranscation post processor this is hooked on the line of business service to 
    ...
    /**
     * Edits a p2p fund transaction after validating the limits and puts into approval queue if required
     * @param methodID
     * @param inputArray
     * @param request
     * @param response
