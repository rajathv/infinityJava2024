...
public class GetBulkWireTemplateTransactionDetail implements JavaService2{
	...
	private static final Logger LOG = LogManager.getLogger(GetBulkWireTemplateTransactionDetail.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		{
			LOG.error("Error occured while fetching  Bulk wire transactions for the template: ", e);
