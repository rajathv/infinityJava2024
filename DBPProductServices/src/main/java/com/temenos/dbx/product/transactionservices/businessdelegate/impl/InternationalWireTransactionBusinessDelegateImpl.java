 ...
 * @author KH1755
 * @version 1.0
 * implements {@link InternationalWireTransactionBusinessDelegate}
 */

public class InternationalWireTransactionBusinessDelegateImpl implements InternationalWireTransactionBusinessDelegate {
	
	private static final Logger LOG = LogManager.getLogger(InternationalWireTransactionBusinessDelegateImpl.class);
	ApplicationBusinessDelegate application = DBPAPIAbstractFactoryImpl.getBusinessDelegate(ApplicationBusinessDelegate.class);
	InternationalWireTransactionBackendDelegate backendDelegate = DBPAPIAbstractFactoryImpl.getBackendDelegate(InternationalWireTransactionBackendDelegate.class);
	...
	private WireTransactionDTO updateStatusUsingConfirmationNumber(String confirmationNumber, String status) {
		...
		Map<String, Object> requestParams = new HashMap<String, Object>();
		requestParams.put("_featureId", Constants.FEATURE_INTERNATIONAL_WIRE_TRANSFER);
