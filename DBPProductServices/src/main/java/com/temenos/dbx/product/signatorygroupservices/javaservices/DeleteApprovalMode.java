...
public class DeleteApprovalMode implements JavaService2 {

private static final Logger LOG = LogManager.getLogger(DeleteApprovalMode.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = approvalModeResource.deleteApprovalMode(methodID, inputArray, request, response);
		}
		catch(Exception e) {
