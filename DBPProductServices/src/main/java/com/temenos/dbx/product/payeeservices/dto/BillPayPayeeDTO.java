...
public class BillPayPayeeDTO implements DBPDTO {
	...
	public BillPayPayeeDTO() {
		super();
	}

	public BillPayPayeeDTO(String id, String typeId, String payeeId, String createdBy, String contractId, String cif,
			String legalEntityId, String isBusinessPayee, String noOfCustomersLinked) {
		super();
		this.id = id;
		this.typeId = typeId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BillPayPayeeDTO other = (BillPayPayeeDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
