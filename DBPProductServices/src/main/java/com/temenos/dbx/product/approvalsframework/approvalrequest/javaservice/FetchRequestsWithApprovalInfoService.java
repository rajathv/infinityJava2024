...
public class FetchRequestsWithApprovalInfoService implements JavaService2 {
    @Override
    public Object invoke(String method, Object[] inputArray, DataControllerRequest dcRequest, DataControllerResponse dcResponse) throws Exception {
        ...
        try {
            result = approvalRequestResource.fetchRequestsWithApprovalInfo(inputMap, dcRequest);
