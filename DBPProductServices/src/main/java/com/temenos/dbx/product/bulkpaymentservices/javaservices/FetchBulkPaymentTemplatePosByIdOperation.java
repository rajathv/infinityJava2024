...
public class FetchBulkPaymentTemplatePosByIdOperation implements JavaService2 {
	
private static final Logger LOG = LogManager.getLogger(FetchBulkPaymentTemplatePosByIdOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = bulkPaymentTemplateResource.fetchPOsByTemplateId(methodID, inputArray, request, response);
		} catch (Exception e) {
			LOG.error("Error occured while invoking fetchPOsByTemplateId: ", e);
