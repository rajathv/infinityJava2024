 ...
 */
public class EditInterBankTransferOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(EditInterBankTransferOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = interBankTransactionResource.editTransaction(methodID, inputArray, request, response);
			...
			LOG.error("Error occured while invoking EditInterBankTransferOperation: ", e);
