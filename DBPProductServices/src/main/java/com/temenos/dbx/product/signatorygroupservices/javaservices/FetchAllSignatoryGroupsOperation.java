...
public class FetchAllSignatoryGroupsOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(FetchAllSignatoryGroupsOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = signatoryGroupResource.fetchAllSignatoryGroups(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of fetchSignatoryGroupsOperation: ", e);
