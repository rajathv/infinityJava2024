 ...
 */
public class CreateBillPayTransactionOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(CreateBillPayTransactionOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = billpayTranscationResource.createTransaction(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Error occured while invoking CreateBillPayTransaction: ", e);
