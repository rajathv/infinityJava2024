...
public class FetchApprovalMode implements JavaService2 {

private static final Logger LOG = LogManager.getLogger(FetchApprovalMode.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = approvalModeResource.fetchApprovalMode(methodID, inputArray, request, response);
		}
		catch(Exception e) {
