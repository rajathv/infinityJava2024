...
public class CreateIntraBankPayeeOperation implements JavaService2 {

    private static final Logger LOG = LogManager.getLogger(CreateIntraBankPayeeOperation.class);
