...
public class BulkPaymentTemplateBusinessDelegateImpl implements BulkPaymentTemplateBusinessDelegate {
	...
	@Override
	public BulkPaymentTemplateDTO createTemplate(BulkPaymentTemplateDTO templateDTO) {
		...
		try {
			...
			if(responseObj.getInt(Constants.OPSTATUS) == 0 && responseObj.getInt(Constants.HTTP_STATUS) == 0) {
				...
				if(bulkpaymentTemplatePODTOs != null) {
					boolean isSuccess = _createTemplatePOs(bulkpaymentTemplatePODTOs);
					if(!isSuccess) {
	...
	private boolean _createTemplatePOs(List<BulkPaymentTemplatePODTO> pos) {
		String serviceName = ServiceId.DBPRBLOCALSERVICEDB;
		String operationName = OperationName.BULKPAYMENT_TEMPLATE_PO_CREATE_PROC;

		Map<String, Object> requestParams = _getMapForTemplatePOs(pos);
	...
	private Map<String, Object> _getMapForTemplatePOs(List<BulkPaymentTemplatePODTO> pos) {

		Map<String,Object> requestParam = new HashMap<String, Object>();

		String poValues = _getPoValue(pos);
		requestParam.put("_povalues", poValues);

		return requestParam;
	}
	
	private String _getPoValue(List<BulkPaymentTemplatePODTO> pos) {
	...
	public String generateCSV(String requestId) {
		...
		try {
            ...
            bulkPaymentRequestPODTOs = fetchRequestPOById(requestId);
	...
	private List<BulkPaymentTemplatePODTO> fetchRequestPOById(String requestId) {
		String serviceName = ServiceId.DBPRBLOCALSERVICEDB;
		...
		try {
			...
			if(responseObj.getInt(Constants.OPSTATUS) == 0 && responseObj.getInt(Constants.HTTP_STATUS) == 0) {
				...
				if(paymentOrders != null) {
					boolean isSuccess = _createTemplateRequestPOs(paymentOrders, responseObj.getString("paymentrequestId"));
					if(!isSuccess) {
	...
	private Map<String, Object> _getMapForTemplateRequestPOs(List<BulkPaymentTemplatePODTO> paymentOrders, String paymentrequestId) {

		Map<String,Object> requestParam = new HashMap<String, Object>();

		String poValues = _getPoRequestValue(paymentOrders, paymentrequestId);
		requestParam.put("_povalues", poValues);

		return requestParam;
	}
	
	private String _getPoRequestValue(List<BulkPaymentTemplatePODTO> paymentOrders, String paymentrequestId) {
	...
	private boolean _createTemplateRequestPOs(List<BulkPaymentTemplatePODTO> paymentOrders, String paymentrequestId) {
		String serviceName = ServiceId.DBPRBLOCALSERVICEDB;
		String operationName = OperationName.BULKPAYMENT_REQUEST_PO_CREATE_PROC;

		Map<String, Object> requestParams = _getMapForTemplateRequestPOs(paymentOrders, paymentrequestId);
