...
public class RejectRequestService implements JavaService2 {
    private static final Logger LOG = Logger.getLogger(RejectRequestService.class);
    @Override
    public Object invoke(String method, Object[] inputArray, DataControllerRequest dcRequest, DataControllerResponse dcResponse) throws Exception {
        ...
        try {
            result = approvalRequestResource.rejectRequest(inputMap, dcRequest);
