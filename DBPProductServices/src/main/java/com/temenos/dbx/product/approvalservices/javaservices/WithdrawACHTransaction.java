 ...
 * @author KH2387
 * @version 1.0
 * Java Service end point to Withdraw ACH Transaction request
 */
public class WithdrawACHTransaction implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(WithdrawACHTransaction.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = approvalQueueResource.withdrawACHTransactionRequest(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of WithdrawACHTransaction: "+e);
		}
