 ...
 */
public class CancelScheduledBillPayTransactionOccurrenceOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(CancelScheduledBillPayTransactionOccurrenceOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = billpayTranscationResource.cancelScheduledTransactionOccurrence(methodID, inputArray, request, response);
		}
		catch(Exception e) {
