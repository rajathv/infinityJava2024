 ...
 */
public class CreateOwnAccountTransferOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(CreateOwnAccountTransferOperation.class);
