 ...
 * @author KH2638
 * @version 1.0
 * Java Service end point to Edit External Payee
 */
public class EditExternalPayeeOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(EditExternalPayeeOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = externalPayeeResource.editPayee(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of EditExternalPayeeOperation: ", e);
