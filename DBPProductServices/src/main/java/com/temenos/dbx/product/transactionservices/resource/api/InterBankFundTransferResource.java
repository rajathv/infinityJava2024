...
public interface InterBankFundTransferResource extends Resource {

    /**
     * creates interbank transaction after validating the limits and puts into approval queue if required
     * @param methodID
     * @param inputArray
     * @param request
     * @param response
	...
	**/
	...
	/** InterBank Transaction post processor this is hooked on the line of business service to 
    ...
    /**
     * Edits an interbank transaction after validating the limits and puts into approval queue if required
     * @param methodID
     * @param inputArray
     * @param request
     * @param response
