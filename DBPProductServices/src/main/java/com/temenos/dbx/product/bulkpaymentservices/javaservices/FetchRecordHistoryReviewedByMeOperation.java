...
public class FetchRecordHistoryReviewedByMeOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(FetchRecordHistoryReviewedByMeOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = bulkPaymentRecordResource.fetchRecordHistoryReviewedByMe(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Error occured while invoking fetchRecordHistoryReviewedByMe: ", e);
