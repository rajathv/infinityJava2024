...
public class UpdateSignatoryGroup implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(UpdateSignatoryGroup.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = signatoryGroupResource.updateSignatoryGroup(methodID, inputArray, request, response);
		}
		catch(Exception e) {
