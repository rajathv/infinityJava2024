 ...
 * @author KH2638
 * @version 1.0
 * Java Service end point to delete Bill Pay Payee 
 */
public class DeleteBillPayPayeeOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(DeleteBillPayPayeeOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = billPayPayeeResource.deletePayee(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of DeleteBillPayPayeeOperation: ", e);
