 ...
 * @author KH2660
 * @version 1.0
 * Java Service end point to Edit WireTransfer Payee
 */
public class EditWireTransfersPayeeOperation implements JavaService2{
	
	private static final Logger LOG = LogManager.getLogger(EditWireTransfersPayeeOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = wireTransfersPayeeResource.editPayee(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of EditWireTransfersPayeeOperation: ", e);
