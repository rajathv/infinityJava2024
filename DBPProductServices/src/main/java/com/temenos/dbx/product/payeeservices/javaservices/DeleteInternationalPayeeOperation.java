...
public class DeleteInternationalPayeeOperation implements JavaService2 {

    private static final Logger LOG = LogManager.getLogger(DeleteInternationalPayeeOperation.class);
