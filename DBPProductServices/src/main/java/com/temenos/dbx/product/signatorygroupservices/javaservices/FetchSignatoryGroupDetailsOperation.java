...
public class FetchSignatoryGroupDetailsOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(FetchSignatoryGroupDetailsOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = signatoryGroupResource.fetchSignatoryGroupDetails(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of fetchSignatoryGroupDetailsOperation: ", e);
