...
public class CreateBulkWireTemplateOperation implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(CreateBulkWireTemplateOperation.class);
    ...
    public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
        ...
        try {
        	...
        	LOG.error("Error occured while invoking CreateBulkWireTemplateOperation: ", e);
