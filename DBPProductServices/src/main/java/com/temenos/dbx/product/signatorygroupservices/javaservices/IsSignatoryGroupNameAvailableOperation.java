...
public class IsSignatoryGroupNameAvailableOperation implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(IsSignatoryGroupNameAvailableOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = signatoryGroupResource.isSignatoryGroupNameAvailable(methodID, inputArray, request, response);
		}
		catch(Exception e) {
			LOG.error("Caught exception at invoke of is group name available operation ", e);
