...
public interface InternationalWireTransferResource extends Resource {

    /**
     * creates International wire transaction after validating the limits and puts into approval queue if required
     * @param methodID
     * @param inputArray
     * @param request
     * @param response
	...
	**/
	...
	/** InternationalWireTransaction post processor this is hooked on the line of business service to 
