 ...
 */
public class DeleteBillPayTransactionOperation implements JavaService2{

	private static final Logger LOG = LogManager.getLogger(DeleteBillPayTransactionOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, 
		...
		try {
			...
			result  = billpayTranscationResource.deleteTransaction(methodID, inputArray, request, response);
		}
		catch(Exception e) {
