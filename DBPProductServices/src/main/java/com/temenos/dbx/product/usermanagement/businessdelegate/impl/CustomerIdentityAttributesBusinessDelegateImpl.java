...
public class CustomerIdentityAttributesBusinessDelegateImpl implements CustomerIdentityAttributesBusinessDelegate {
    ...
    private JsonObject prepareUserAttributes(CustomerDTO customerDTO, Map<String, Object> headerMap)
        ...
        try {
            ...
            userAttributes.addProperty("defaultLegalEntity", customerDTO.getDefaultLegalEntity());
            userAttributes.addProperty("homeLegalEntity", customerDTO.getHomeLegalEntity());
			...
			userAttributes.addProperty("legalEntityId", companyId.toString());
        } catch (Exception e) {
    ...
    @Override
    public JsonObject getSecurityAttributes(CustomerDTO customerDTO, Map<String, Object> headerMap, String legalEntityId)
            throws ApplicationException {
        ...
        if (StringUtils.isBlank(legalEntityId))
			legalEntityId = companyId.toString();
        ...
        Map<String, Set<String>> securityAttributes =
                businessDelegate.getSecurityAttributes(customerDTO.getId(), headerMap,legalEntityId);
