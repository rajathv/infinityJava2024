 ...
 */
public class FetchApprovalMatrixOperation implements JavaService2  {

	@Override
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, DataControllerResponse response)
	{
		final Logger LOG = LogManager.getLogger(FetchApprovalMatrixOperation.class);
		try 
		{	
			...
			Result result = approvalMatrixResource.fetchApprovalMatrix(methodID, inputArray, request, response);
			return result;
		} 
		catch(Exception e) 
		{
