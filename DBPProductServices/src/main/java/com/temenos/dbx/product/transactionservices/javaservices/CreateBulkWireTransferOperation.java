...
public class CreateBulkWireTransferOperation implements JavaService2 {
    private static final Logger LOG = LogManager.getLogger(CreateBulkWireTransferOperation.class);
    ...
    public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
        ...
        try {
            ...
            LOG.error("Caught exception at invoke of CreateBulkWireTransferOperation:",e);
