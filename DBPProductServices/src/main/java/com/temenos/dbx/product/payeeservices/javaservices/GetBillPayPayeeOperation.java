 ...
 * @author KH2638
 * @version 1.0
 * Java Service end point to fetch all the Bill Pay Payees associated with User
 */
public class GetBillPayPayeeOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetBillPayPayeeOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			BillPayPayeeResource billPayPayeeResource = DBPAPIAbstractFactoryImpl.getInstance()
					...
					result  = billPayPayeeResource.fetchAllMyPayees(methodID, inputArray, request, response);
		}
		catch(Exception e) {
