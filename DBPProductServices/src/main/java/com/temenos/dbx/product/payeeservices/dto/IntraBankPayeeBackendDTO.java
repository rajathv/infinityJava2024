...
public class IntraBankPayeeBackendDTO  implements DBPDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (getClass() != o.getClass())
            return false;
        IntraBankPayeeBackendDTO other = (IntraBankPayeeBackendDTO) o;
        if (id == null) {
            if (other.id != null)
                return false;
