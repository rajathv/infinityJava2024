...
public class VerifyLoginMFAOTPPostProcessor implements ObjectServicePostProcessor {

	private static final Logger LOG = LogManager.getLogger(VerifyLoginMFAOTPPostProcessor.class);
	...
	public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
		...
		String producer = "RBObjects/DbxUser/verifyLoginMFAOTP";
