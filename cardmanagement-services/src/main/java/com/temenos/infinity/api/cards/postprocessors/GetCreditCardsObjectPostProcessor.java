...
public class GetCreditCardsObjectPostProcessor
    ...
    public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
        ...
        try {
            ...
            if(requestPayloadHandler.getPayloadAsJson().getAsJsonObject() != null && requestPayloadHandler.getPayloadAsJson().getAsJsonObject().toString().equals("{}")) {
            ...
            String producer = "RBObjects/objects/getCardDetails";
