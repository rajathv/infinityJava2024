 ...
 * @author KH2394
 * @version 1.0
 * Java Service end point to get CardProducts
 */
public class GetCardProductsOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = cardResource.getCardProducts(methodID, inputArray, request, response);
		}
		catch(Exception e) {
