...
public class ReplaceCreditCardObjectPostProcessor implements ObjectServicePostProcessor, ObjectServicesConstants {

    private static final Logger logger = LogManager.getLogger(ReplaceCreditCardObjectPostProcessor.class);
    ...
    public void execute(FabricRequestManager requestManager, FabricResponseManager responseManager) throws Exception {
        ...
        try {
            ...
            String eventSubType = REPLACE_CARD;
            String producer = "RBObjects/objects/Cards/replaceCard";
