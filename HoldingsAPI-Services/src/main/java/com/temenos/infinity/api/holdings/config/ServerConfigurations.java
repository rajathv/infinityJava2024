...
public enum ServerConfigurations implements Serializable {
    ...
    AMS_COMPANYID, T24_PRIVATE_ENCRYPTION_KEY, DBP_HOST_URL, HOLDINGS_PRIVATE_ENCRYPTION_KEY, HOLDINGS_DEPLOYMENT_PLATFORM, HOLDINGS_AUTHORIZATION_KEY, HOLDINGS_ROLE_ID,ARRANGEMENTS_BACKEND,DMS_INTEGRATION_ENABLED;
