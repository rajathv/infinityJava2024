...
public class CreateDisputeCoreTransaction implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(CreateDisputeCoreTransaction.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = ruleResource.crearteDisputeCoreTransaction(methodID, inputArray, request, response);
		}
		catch(Exception e) {
