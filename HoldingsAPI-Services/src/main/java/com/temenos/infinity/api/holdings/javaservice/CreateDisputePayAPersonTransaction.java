...
public class CreateDisputePayAPersonTransaction implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(CreateDisputePayAPersonTransaction.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = ruleResource.crearteDisputePayAPersonTransaction(methodID, inputArray, request, response);
		}
		catch(Exception e) {
