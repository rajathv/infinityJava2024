...
public class CreateOrderServiceRequestPreprocessor implements JavaService2{

	private static final Logger logger = LogManager.getLogger(com.temenos.infinity.api.holdings.javaservice.CreateOrderServiceRequest.class);
