...
public class CloseSavingsPot implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(CloseSavingsPot.class);
	@Override
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = savingsPotResource.closeSavingsPot(methodID, inputArray, request, response);
		}
		catch(Exception e) {
