package com.kony.campaign.servlet;
...
import com.kony.campaign.mapper.BaseBusinessDelegateMapper;
import com.kony.campaign.mapper.BaseResourcesMapper;
...
public class BusinessAPIsBaseCustomResourcesServlet extends HttpServlet {
    ...
    @Override
    public void destroy() {
    	CampaignThreadPoolExecutor.shutDown();
    }
