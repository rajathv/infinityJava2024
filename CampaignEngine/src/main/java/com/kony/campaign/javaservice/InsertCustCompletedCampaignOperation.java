...
public class InsertCustCompletedCampaignOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request, DataControllerResponse response)
		...
		return campaignResource.insertCustCompletedCampaigns(methodID, inputArray, request, response);
