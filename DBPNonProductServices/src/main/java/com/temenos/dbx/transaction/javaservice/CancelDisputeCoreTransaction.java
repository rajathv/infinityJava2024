...
public class CancelDisputeCoreTransaction implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(CancelDisputeCoreTransaction.class);
