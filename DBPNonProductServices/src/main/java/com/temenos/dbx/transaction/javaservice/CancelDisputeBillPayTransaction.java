...
public class CancelDisputeBillPayTransaction implements JavaService2 {

	private static final Logger LOG = LogManager.getLogger(CancelDisputeBillPayTransaction.class);
