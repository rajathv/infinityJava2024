...
import com.temenos.dbx.transaction.businessdelegate.impl.SwiftCodeBusinessDelegateImpl;


public class SwiftCodeBusinessDelegateMapper implements DBPAPIMapper<BusinessDelegate>{
