...
public class GetSameBankAccount implements JavaService2 {
    ...
    private boolean preProcess(Map<String, String> inputParams, DataControllerRequest dcRequest, Result result) throws HttpCallException {
        ...
        String payeeId = (String) inputParams.get(DBPInputConstants.ID);
        ...
        sb.append(DBPUtilitiesConstants.AND);
        sb.append(DBPUtilitiesConstants.IS_SAME_BANK_ACCNT).append(DBPUtilitiesConstants.EQUAL).append("1");
