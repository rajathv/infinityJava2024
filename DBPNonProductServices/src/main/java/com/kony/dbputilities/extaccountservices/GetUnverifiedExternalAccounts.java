...
public class GetUnverifiedExternalAccounts implements JavaService2 {
    ...
    private boolean preProcess(Map inputParams, DataControllerRequest dcRequest, Result result) {
        ...
        sb.append(DBPUtilitiesConstants.AND);
        sb.append(DBPUtilitiesConstants.IS_VERIFIED).append(DBPUtilitiesConstants.EQUAL).append("0");
