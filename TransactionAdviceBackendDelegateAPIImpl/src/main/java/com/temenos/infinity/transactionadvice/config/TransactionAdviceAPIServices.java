package com.temenos.infinity.transactionadvice.config;
...
public enum TransactionAdviceAPIServices implements InfinityServices {
	...
	TRANSACTIONADVICEJSON_LOGIN("TransactionAdviceJSONServices", "login"), TRANSACTIONADVICEJSON_SEARCH("TransactionAdviceJSONServices",
					"getYearlyFilesDetails"), TRANSACTIONADVICEJSON_DOWNLOAD("TransactionAdviceJSONServices", "filedownload");
