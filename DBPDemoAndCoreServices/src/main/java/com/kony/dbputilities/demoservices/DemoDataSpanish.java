...
public class DemoDataSpanish {
    ...
    public Map<String, String> getUser1DemoData() {
        ...
        inputParam.put("userfirstname", "Adolfo");
        inputParam.put("userlastname", "Cabrales Mato");
        inputParam.put("gender", "Male");
        inputParam.put("dateOfBirth", "1983-06-10");
        inputParam.put("PersonalIDType", "DNI (documento nacional de identidad)");
        inputParam.put("ssn", "41235056-k");
        inputParam.put("email", "user.acabrales@gmail.com");
        inputParam.put("phone", "+91-647739835");
        inputParam.put("phoneExtension", "647739835");
        inputParam.put("phoneCountryCode", "+34");
        inputParam.put("secondaryemail", "");
        inputParam.put("secondaryphone", "");
        inputParam.put("secondaryemail2", "");
        inputParam.put("secondaryphone2", "");
        inputParam.put("addressLine1", "Calle Conde de Barajas 22");
        inputParam.put("addressLine2", "");
        inputParam.put("city", "Sevilla");
        inputParam.put("state", "Andalucía");
        inputParam.put("countryCode", "ES");
        inputParam.put("country", "España");
        inputParam.put("zipcode", "41002");
    ...
    public Map<String, String> getCustomerDemoData() {
        Map<String, String> inputParam = new HashMap<>();
        inputParam.put("FirstName", "Adolfo");
        inputParam.put("LastName", "Cabrales Mato");
        // inputParam.put("UserImageURL", "https://retailbanking1.konycloud.com/dbimages/displayPicture.png");
    ...
    public Map<String, String> getAddress1DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        inputParam.put("Region_id", "REGION_ID87");
        inputParam.put("isPreferredAddress", "1");
        inputParam.put("City_id", "C5");
        inputParam.put("cityName", "Sevilla");
        inputParam.put("addressLine1", "Calle Conde de Barajas 22");
        inputParam.put("zipCode", "41002");
    ...
    public Map<String, String> getPhone1DemoData() {
        ...
        inputParam.put("phoneNumber", "+91-647739835");
    ...
    public Map<String, String> getUser2DemoData() {
        ...
        inputParam.put("userfirstname", "Alejandra");
        inputParam.put("userlastname", "Silva");

        inputParam.put("gender", "Female");
        inputParam.put("dateOfBirth", "1982-11-28");

        inputParam.put("PersonalIDType", "DNI (documento nacional de identidad)");

        inputParam.put("ssn", "51234365-e");

        inputParam.put("email", "user.asilva@gmail.com");

        inputParam.put("phone", "+91-656651276");
        inputParam.put("phoneExtension", "656651276");
        inputParam.put("phoneCountryCode", "+34");
        ...
        inputParam.put("areDepositTermsAccepted", "0");
        inputParam.put("areAccountStatementTermsAccepted", "0");
        inputParam.put("default_account_desposit", "ES3721000813610123459000");
        inputParam.put("default_account_transfers", "ES3721000813610123459000");
        inputParam.put("default_account_payments", "ES3721000813610123459000");
        inputParam.put("default_account_cardless", "ES3721000813610123459000");
        inputParam.put("isPhoneEnabled", "0");
        inputParam.put("isBillPaySupported", "1");
        inputParam.put("isP2PSupported", "1");
        inputParam.put("isBillPayActivated", "1");
    ...
    public Map<String, String> getAccount1DemoData() {
        ...
        inputParam.put("AccountName", "Cuenta de ahorros");
        inputParam.put("NickName", "Mis ahorros");
        ...
        inputParam.put("AccountHolder", "Adolfo Cabrales Mato");
        inputParam.put("RoutingNumber", "");
        inputParam.put("SwiftCode", "");
        inputParam.put("BsbNum", "");
        inputParam.put("JointHolders", "Alejandra Silva");
        ...
        inputParam.put("IBAN", "ES08 2100 0813 6101 2345 7000");
    ...
    public Map<String, String> getAccount2DemoData() {
        ...
        inputParam.put("AccountName", "cuenta de cheques");
        inputParam.put("NickName", "Mis cheques");
        inputParam.put("OpeningDate", "2016-11-23");
        inputParam.put("closingDate", "");
        inputParam.put("StatusDesc", "Active");
        inputParam.put("FavouriteStatus", "");
        ...
        inputParam.put("interestPaidLastYear", "");
        inputParam.put("bankName", "Infinity Europe");
        inputParam.put("IBAN", "ES37 2100 0813 6101 2345 9000");
        inputParam.put("Sort Code", "");
        inputParam.put("AccountHolder2", "John Doe");
        return inputParam;
    }

    public Map<String, String> getInternalTransfer_SAV2DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        inputParam.put("transactionType", "InternalTransfer");
        inputParam.put("fromAccountNumber", "ES08 2100 0813 6101 2345 7000");
        inputParam.put("toAccountNumber", "ES37 2100 0813 6101 2345 9000");
        ...
        inputParam.put("description", "Ahorro mensual");
    ...
    public Map<String, String> getInterest_SAV6DemoData() {
        ...
        inputParam.put("toAccountNumber", "ES08 2100 0813 6101 2345 7000");
        inputParam.put("toExternalAccountNumber", "");
        inputParam.put("transactionCurrency", "EUR");
        inputParam.put("amount", "300.00");
        inputParam.put("baseCurrency", "EUR");
    ...
    public Map<String, String> getWithdrawal_Current16DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        inputParam.put("transactionType", "Withdrawal");
        inputParam.put("fromAccountNumber", "ES37 2100 0813 6101 2345 9000");
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Retiro en cajero automático");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1392");
    ...
    public Map<String, String> getExternalTransfer_Current17DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Transferencia externa");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Pending");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
    ...
    public Map<String, String> getPOS_Current18DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Pago en Taberna Ipuzcoa Madrid");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1624");
        inputParam.put("createdDate", "-10");
        inputParam.put("transactionDate", "-10");
        inputParam.put("viewReportLink", "http://retailbanking1.konycloud.com/dbimages/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    public Map<String, String> getCredit_Current19DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Devolución compras en El Corte Inglés");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
    ...
    public Map<String, String> getBillPay_Current20DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Telefónica España S.L.");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1649");
        inputParam.put("createdDate", "-10");
        inputParam.put("transactionDate", "-10");
        inputParam.put("viewReportLink", "http://retailbanking1.konycloud.com/dbimages/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    public Map<String, String> getInternetTransaction_Current21DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "amazon.es");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1729");
        inputParam.put("createdDate", "-10");
        inputParam.put("transactionDate", "-10");
        inputParam.put("viewReportLink", "http://retailbanking1.konycloud.com/dbimages/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    public Map<String, String> getReceivedP2P_Current22DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("convertedAmount", "100");
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Entradas concierto");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
    ...
    public Map<String, String> getExternalTransfer_Current23DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        inputParam.put("transactionType", "ExternalTransfer");
        inputParam.put("fromAccountNumber", "ES37 2100 0813 6101 2345 9000");
        inputParam.put("toAccountNumber", "");
        ...
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1664");
        inputParam.put("createdDate", "-11");
        inputParam.put("transactionDate", "-11");
        inputParam.put("viewReportLink", "http://retailbanking1.konycloud.com/dbimages/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    public Map<String, String> getBillPay_Current24DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        inputParam.put("transactionType", "BillPay");
        inputParam.put("fromAccountNumber", "ES37 2100 0813 6101 2345 9000");
        inputParam.put("toAccountNumber", "");
        inputParam.put("toExternalAccountNumber", "");
        inputParam.put("transactionCurrency", "EUR");
        inputParam.put("amount", "150");
        inputParam.put("baseCurrency", "EUR");
        inputParam.put("convertedAmount", "150");
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Recibo Gas Natural Fenosa");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1764");
        inputParam.put("createdDate", "-11");
        inputParam.put("transactionDate", "-11");
        inputParam.put("viewReportLink", "http://retailbanking1.konycloud.com/dbimages/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    public Map<String, String> getP2P_Current25DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Cañas con los colegas");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1914");
        inputParam.put("createdDate", "-11");
        inputParam.put("transactionDate", "-11");
        inputParam.put("viewReportLink", "http://retailbanking1.konycloud.com/dbimages/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    public Map<String, String> getInterest_Current26DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        inputParam.put("transactionType", "Interest");
        inputParam.put("fromAccountNumber", "");
        inputParam.put("toAccountNumber", "ES37 2100 0813 6101 2345 9000");
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Intereses devengados");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
    ...
    public Map<String, String> getLoan_Current27DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Cuota del préstamo del coche octubre");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
    ...
    public Map<String, String> getCardless_Current28DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Cine y chuches para los niños");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
    ...
    public Map<String, String> getExternalTransfer_Current29DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        inputParam.put("transactionType", "ExternalTransfer");
        inputParam.put("fromAccountNumber", "ES37 2100 0813 6101 2345 9000");
        inputParam.put("toAccountNumber", "");
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Renta noviembre");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
    ...
    public Map<String, String> getInternalTransfer_Current30DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        inputParam.put("transactionType", "InternalTransfer");
        inputParam.put("fromAccountNumber", "ES37 2100 0813 6101 2345 9000");
        inputParam.put("toAccountNumber", "ES08 2100 0813 6101 2345 7000");
    ...
    public Map<String, String> getPayroll_Current31DemoData() {
        Map<String, String> inputParam = new HashMap<>();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Ingreso de nómina");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
