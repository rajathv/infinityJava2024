...
public class DemoDataUK {
    ...
    public Map<String, String> getUser1DemoData() {
        ...
        inputParam.put("userfirstname", "Richard");
        inputParam.put("userlastname", "Starkey");
        inputParam.put("gender", "Male");
        inputParam.put("dateOfBirth", "1990-07-07");
        inputParam.put("PersonalIDType", "NIN (Nantional Insurance Number)");
        inputParam.put("ssn", "QQ246810B");
        inputParam.put("email", "user.rstarkey@gmail.com");
        inputParam.put("phone", "+91-6656765371");
        inputParam.put("phoneExtension", "6656765371");
        inputParam.put("phoneCountryCode", "+44");
        inputParam.put("secondaryemail", "");
        inputParam.put("secondaryphone", "");
        inputParam.put("secondaryemail2", "");
        inputParam.put("secondaryphone2", "");
        inputParam.put("addressLine1", "Merrion St");
        inputParam.put("addressLine2", "");
        inputParam.put("city", "Leeds");
        inputParam.put("state", "West Yorkshire");
        inputParam.put("countryCode", "GB");
        inputParam.put("country", "United Kingdom");
        inputParam.put("zipcode", "LS2 8LQ");
        ...
        inputParam.put("default_account_desposit", "DE64 1000 0000 0123 4567 90");
        inputParam.put("default_account_transfers", "DE64 1000 0000 0123 4567 90");
        inputParam.put("default_account_payments", "DE64 1000 0000 0123 4567 90");
        inputParam.put("default_account_cardless", "DE64 1000 0000 0123 4567 90");
    ...
    public Map<String, String> getCustomerDemoData() {
        ...
        inputParam.put("FirstName", "Richard");
        inputParam.put("LastName", "Starkey");
        // inputParam.put("UserImageURL", "https://retailbanking1.konycloud.com/dbimages/displayPicture.png");
    ...
    public Map<String, String> getAddress1DemoData() {
        Map inputParam = new HashMap();
        inputParam.put("Region_id", "R19");
        inputParam.put("isPreferredAddress", "1");
        inputParam.put("City_id", "CITY548");
        inputParam.put("cityName", "Leeds");
        inputParam.put("addressLine1", "Merrion St");
        inputParam.put("addressLine2", "");
        inputParam.put("zipCode", "LS2 8LQ");
        inputParam.put("country", "UK");
    ...
    public Map<String, String> getPhone1DemoData() {
        ...
        inputParam.put("phoneNumber", "+91-6656765371");
    ...
    public Map<String, String> getUser2DemoData() {
        Map inputParam = new HashMap();
        inputParam.put("userfirstname", "Charlotte");
        inputParam.put("userlastname", "Church");
        inputParam.put("gender", "Female");
        inputParam.put("dateOfBirth", "1991-04-09");
        inputParam.put("PersonalIDType", "NIN (Nantional Insurance Number)");
        inputParam.put("ssn", "QQ246810B");
        inputParam.put("email", "user.cchurch@gmail.com");
        inputParam.put("phone", "+91-6656712371");
        inputParam.put("phoneExtension", "6656712371");
        inputParam.put("phoneCountryCode", "+44");
        inputParam.put("secondaryemail", "");
        inputParam.put("secondaryphone", "");
        inputParam.put("secondaryemail2", "");
        ...
        inputParam.put("areDepositTermsAccepted", "0");
        inputParam.put("areAccountStatementTermsAccepted", "0");
        inputParam.put("default_account_desposit", "ES37 2100 0813 6101 2345 9000");
        inputParam.put("default_account_transfers", "ES37 2100 0813 6101 2345 9000");
        inputParam.put("default_account_payments", "ES37 2100 0813 6101 2345 9000");
        inputParam.put("default_account_cardless", "ES37 2100 0813 6101 2345 9000");
        inputParam.put("isPhoneEnabled", "0");
        inputParam.put("isBillPaySupported", "1");
        inputParam.put("isP2PSupported", "1");
        inputParam.put("isBillPayActivated", "1");
    ...
    public Map<String, String> getAccount1DemoData() {
        ...
        inputParam.put("AccountName", "Savings account");
        ...
        inputParam.put("AvailableBalance", "57300.00");
        inputParam.put("CurrentBalance", "57300.00");
        inputParam.put("PendingDeposit", "500.00");
        inputParam.put("PendingWithdrawal", "0.00");
        ...
        inputParam.put("EStatementmentEnable", "");
        inputParam.put("AccountPreference", "");
        inputParam.put("CurrencyCode", "GBP");
        inputParam.put("AccountHolder", "Richard Starkey");
        inputParam.put("RoutingNumber", "12-34-56");
        inputParam.put("SwiftCode", "UBKLGB2L");
        inputParam.put("BsbNum", "");
        inputParam.put("JointHolders", "Charlotte Church");
        ...
        inputParam.put("IBAN", "GB23 MIDL 0700 9312 3456 70");
        inputParam.put("Sort Code", "07-00-93");
    ...
    public Map<String, String> getAccount2DemoData() {
        ...
        inputParam.put("CurrentBalance", "4589.28");
        inputParam.put("PendingDeposit", "200");
        inputParam.put("PendingWithdrawal", "-89.28");
        inputParam.put("lastStatementBalance", "");
        inputParam.put("ShowTransactions", "1");
        inputParam.put("SupportBillPay", "1");
        inputParam.put("SupportDeposit", "1");
        ...
        inputParam.put("interestPaidLastYear", "");
        inputParam.put("bankName", "Infinity Europe");
        inputParam.put("IBAN", "GB65 MIDL 0700 9312 3456 90");
        inputParam.put("Sort Code", "07-00-93");
        inputParam.put("adminProductId", "");
        inputParam.put("AccountHolder2", "John Doe");
        return inputParam;
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getInternalTransfer_SAV4DemoData() {
        Map inputParam = new HashMap();
        inputParam.put("transactionType", "InternalTransfer");
        inputParam.put("fromAccountNumber", "GB23 MIDL 0700 9312 3456 70");
        inputParam.put("toAccountNumber", "GB65 MIDL 0700 9312 3456 90");
        inputParam.put("toExternalAccountNumber", "");
        inputParam.put("transactionCurrency", "GBP");
        inputParam.put("amount", "300");
        inputParam.put("baseCurrency", "GBP");
        inputParam.put("convertedAmount", "300");
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Monthly savings");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "57300");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getInterest_SAV8DemoData() {
        Map inputParam = new HashMap();
        inputParam.put("transactionType", "Interest");
        inputParam.put("fromAccountNumber", "");
        inputParam.put("toAccountNumber", "GB23 MIDL 0700 9312 3456 70");
        inputParam.put("toExternalAccountNumber", "");
        inputParam.put("transactionCurrency", "GBP");
        inputParam.put("amount", "300");
        inputParam.put("baseCurrency", "GBP");
        ...
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1719");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getWithdrawal_Current47DemoData() {
        Map inputParam = new HashMap();
        inputParam.put("transactionType", "Withdrawal");
        inputParam.put("fromAccountNumber", "GB65 MIDL 0700 9312 3456 90");
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "ATM Withdrawal");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1175.42");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getExternalTransfer_Current48DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("transactionCurrency", "GBP");
        inputParam.put("amount", "89.2857142857143");
        inputParam.put("baseCurrency", "EUR");
        inputParam.put("convertedAmount", "100");
        inputParam.put("checkNumber", "");
        inputParam.put("description", "External Transfer");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Pending");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1295.42857142857");
        inputParam.put("createdDate", "-16");
        inputParam.put("transactionDate", "-16");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getPOS_Current49DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "THE ORCHARD BROCKLEY");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1384.71");
        inputParam.put("createdDate", "-16");
        inputParam.put("transactionDate", "-16");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getBillPay_Current50DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("toExternalAccountNumber", "");
        inputParam.put("transactionCurrency", "GBP");
        inputParam.put("amount", "80");
        inputParam.put("baseCurrency", "EUR");
        inputParam.put("convertedAmount", "80");
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Vodafone U.K.");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1434.71428571429");
        inputParam.put("createdDate", "-16");
        inputParam.put("transactionDate", "-16");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getInternetTransaction_Current51DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "amazon.co.uk");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1514.71");
        inputParam.put("createdDate", "-16");
        inputParam.put("transactionDate", "-16");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getReceivedP2P_Current52DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("convertedAmount", "100");
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Concert tickets");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1559.71428571429");
        inputParam.put("createdDate", "-16");
        inputParam.put("transactionDate", "-16");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getCredit_Current53DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Reimbursement Apple Store London");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1449.71");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getExternalTransfer_Current54DemoData() {
        Map inputParam = new HashMap();
        inputParam.put("transactionType", "ExternalTransfer");
        inputParam.put("fromAccountNumber", "GB65 MIDL 0700 9312 3456 90");
        inputParam.put("toAccountNumber", "");
        ...
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1424.71428571429");
        inputParam.put("createdDate", "-17");
        inputParam.put("transactionDate", "-17");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getP2P_Current55DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Drinks after the game");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1514");
        inputParam.put("createdDate", "-17");
        inputParam.put("transactionDate", "-17");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getInterest_Current56DemoData() {
        Map inputParam = new HashMap();
        inputParam.put("transactionType", "Interest");
        inputParam.put("fromAccountNumber", "");
        inputParam.put("toAccountNumber", "GB65 MIDL 0700 9312 3456 90");
        ...
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1540");
        inputParam.put("createdDate", "-17");
        inputParam.put("transactionDate", "-17");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getLoan_Current57DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Car loan");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "1530");
        inputParam.put("createdDate", "-17");
        inputParam.put("transactionDate", "-17");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getCardless_Current58DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Cinema and snacks for the kids");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "2230");
        inputParam.put("createdDate", "-17");
        inputParam.put("transactionDate", "-17");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getExternalTransfer_Current59DemoData() {
        Map inputParam = new HashMap();
        inputParam.put("transactionType", "ExternalTransfer");
        inputParam.put("fromAccountNumber", "GB65 MIDL 0700 9312 3456 90");
        inputParam.put("toAccountNumber", "");
        ...
        inputParam.put("checkNumber", "");
        inputParam.put("description", "November rent");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "2300");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getInternalTransfer_Current60DemoData() {
        Map inputParam = new HashMap();
        inputParam.put("transactionType", "InternalTransfer");
        inputParam.put("fromAccountNumber", "GB65 MIDL 0700 9312 3456 90");
        inputParam.put("toAccountNumber", "GB23 MIDL 0700 9312 3456 70");
        ...
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "4300");
        inputParam.put("createdDate", "-18");
        inputParam.put("transactionDate", "-18");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public Map<String, String> getPayroll_Current61DemoData() {
        Map inputParam = new HashMap();
        ...
        inputParam.put("toExternalAccountNumber", "");
        inputParam.put("transactionCurrency", "GBP");
        inputParam.put("amount", "4600");
        inputParam.put("baseCurrency", "GBP");
        inputParam.put("convertedAmount", "4600");
        inputParam.put("checkNumber", "");
        inputParam.put("description", "Nov payroll");
        inputParam.put("notes", "");
        inputParam.put("statusDesc", "Successful");
        inputParam.put("frequencyType", "Once");
        inputParam.put("toAccountBalance", "");
        inputParam.put("fromAccountBalance", "4600");
        inputParam.put("createdDate", "-18");
        inputParam.put("transactionDate", "-18");
        inputParam.put("viewReportLink", "http://pmqa.konylabs.net/KonyWebBanking/view_report.png");
        inputParam.put("numberOfRecurrences", "0");
