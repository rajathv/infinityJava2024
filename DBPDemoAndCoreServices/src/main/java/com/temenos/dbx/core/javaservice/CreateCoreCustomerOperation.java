...
public class CreateCoreCustomerOperation implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
		...
		logger = new LoggerUtil(CreateCoreCustomerOperation.class);
		 ...
		 Result result = new Result();
	        try {
	           ...
	           result = customerResource.saveFromParty(methodID, inputArray, dcRequest, dcResponse);
	        } catch (Exception e) {
