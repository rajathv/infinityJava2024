...
public enum USStates {
    ...
    USStates(String stateName, String ansiCode, String isoCode) {
    ...
    public static USStates parse(String input) {
        ...
        for (USStates state : values()) {
            if (state.stateName.equalsIgnoreCase(input)    ||
                state.ansiCode.equalsIgnoreCase(input) ||
                state.isoCode.equalsIgnoreCase(input)) {
                return state;
            }
        }
        return null;
