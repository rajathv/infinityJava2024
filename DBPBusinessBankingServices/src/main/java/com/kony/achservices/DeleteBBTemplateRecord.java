...
public class DeleteBBTemplateRecord implements JavaService2 {
    /**
     * @param s
     * @param objects
    ...
    public Object invoke(String s, Object[] objects, DataControllerRequest dataControllerRequest,
        ...
        return deleteBBTemplateRecordHelper(inputParams, dataControllerRequest);
    }
     ...
     * @return
     * @throws Exception
     * @description Helper function for removing template record of a BB User
     */
    public Result deleteBBTemplateRecordHelper(Map<String, String> inputParams, DataControllerRequest dcr)
            throws Exception {
