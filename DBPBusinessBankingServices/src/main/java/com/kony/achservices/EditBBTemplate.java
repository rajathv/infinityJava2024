...
public class EditBBTemplate implements JavaService2 {
    /**
     * @param s
     * @param objects
    ...
    public Object invoke(String s, Object[] objects, DataControllerRequest dataControllerRequest,
        ...
        return editBBTemplateHelper(inputParams, dataControllerRequest);
    }
     ...
     * @return
     * @throws Exception
     * @description Helper function for editing template of a BB User
     */
    public Result editBBTemplateHelper(Map<String, String> inputParams, DataControllerRequest dcr) throws Exception {
