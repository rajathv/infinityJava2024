...
public class GetCardsForAdminPostProcessor extends TemenosBasePostProcessor {
	private static final Logger logger = LogManager.getLogger(GetCardsForAdminPostProcessor.class);
...
//				}
			...
			logger.error("Exception Occured while in getCardsForAdmin cards post processor:" + e);
