...
public class GetOtherBankAccountPostProcessor extends BasePostProcessor implements ExternalAccountsConstants{
	  ...
	  public Result execute(Result result, DataControllerRequest request,
		...
		if(externalAccounts != null) {			
			...
			while(iter.hasNext()) {
				...
				if(TRANSACTION_TYPE_BCIB.equalsIgnoreCase(transactionType)) {
