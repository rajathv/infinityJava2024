...
public class UpdateCheckingAccNickNamePreProcessor extends TemenosBasePreProcessor implements AccountsConstants {

	private static final Logger logger = LogManager.getLogger(UpdateCheckingAccNickNamePreProcessor.class);
	...
	public boolean execute(HashMap params, DataControllerRequest request, DataControllerResponse response,
		...
		if (accounts != null && !"".equalsIgnoreCase(nickName) && Constants.ACCOUNT_TYPE_CHECKING.equalsIgnoreCase(accounts.get(accountId).getAccountType())) {
