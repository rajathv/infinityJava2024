...
public class UpdateAccountNickNamePreProcessor extends TemenosBasePreProcessor implements AccountsConstants {

	private static final Logger logger = LogManager.getLogger(UpdateAccountNickNamePreProcessor.class);
	...
	public boolean execute(HashMap params, DataControllerRequest request, DataControllerResponse response,
		...
		if (accounts != null && !"".equalsIgnoreCase(nickName) && Constants.ACCOUNT_TYPE_SAVINGS.equalsIgnoreCase(accounts.get(accountId).getAccountType())) {
