...
public class PDFGeneratorChangeRepaymentAccountReqAck {
	...
	public PDFGeneratorChangeRepaymentAccountReqAck(Map<String, Object> changeRepaymentAccountFields) {
	...
	public String generateFileAndGetBase64() {
		try {
			...
			//adding header
			addHeaderLabel(document, "Change repayment Account Request Details");
