...
public class AddSavingsAccountBannerPreProcessor extends TemenosBasePreProcessor implements AccountsConstants{

	private static final Logger logger = LogManager.getLogger(AddSavingsAccountBannerPreProcessor.class);
	@Override
	public boolean execute(HashMap params, DataControllerRequest request, DataControllerResponse response, Result result)
		...
		if (Constants.ACCOUNT_TYPE_SAVINGS.equalsIgnoreCase(productType)) {
