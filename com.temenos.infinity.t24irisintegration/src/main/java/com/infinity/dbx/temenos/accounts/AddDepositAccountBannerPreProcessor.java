...
public class AddDepositAccountBannerPreProcessor extends TemenosBasePreProcessor implements AccountsConstants{

	private static final Logger logger = LogManager.getLogger(AddDepositAccountBannerPreProcessor.class);
	@Override
	public boolean execute(HashMap params, DataControllerRequest request, DataControllerResponse response, Result result)
		...
		if (Constants.ACCOUNT_TYPE_DEPOSIT.equalsIgnoreCase(productType)) {
