...
public interface AddCurrencyBusinessDelegate extends BusinessDelegate {
	 ...
	 * @param headersMap
	 */
	Result getAddCurrency(String methodID, Object[] inputArray, DataControllerRequest request,
