...
public interface StockNewsBusinessDelegate extends BusinessDelegate {
	 ...
	 * @param headersMap
	 */
	Result getStockNews(String methodID, Object[] inputArray, DataControllerRequest request,
