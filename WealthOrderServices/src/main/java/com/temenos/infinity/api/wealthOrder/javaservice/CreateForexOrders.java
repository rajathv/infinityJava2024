...
public class CreateForexOrders implements JavaService2{
	private static final Logger LOG = LogManager.getLogger(CreateForexOrders.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			//Initializing of currencyResource through Abstract factory method
			...
			result  = currencyResource.createForexOrders(methodID, inputArray, request, response);
		}
		catch(Exception e) {
