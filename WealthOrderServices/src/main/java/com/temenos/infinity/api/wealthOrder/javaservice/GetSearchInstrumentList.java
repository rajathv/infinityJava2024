 ...
 *
 */
public class GetSearchInstrumentList implements JavaService2 {
	private static final Logger log = LogManager.getLogger(GetSearchInstrumentList.class);
	@Override
	public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = holdingsListResource.getSearchInstrumentList(methodId, inputArray, request, response);
			}
			catch(Exception e) {
