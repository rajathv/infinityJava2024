...
public interface PricingDataBusinessDelegate extends BusinessDelegate {
	 ...
	 * @param headersMap
	 */
	Result getPricingData(String methodID, Object[] inputArray, DataControllerRequest request,
