...
public class PartyRelationsUpdateOperation implements JavaService2
{
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
        ...
        Result result = new Result();
           try {
              ...
              result = customerResource.partyRelationsUpdate(methodID, inputArray, dcRequest, dcResponse);
           } catch (Exception e) {
