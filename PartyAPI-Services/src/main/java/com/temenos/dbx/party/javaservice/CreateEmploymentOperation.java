 ...
 */
public class CreateEmploymentOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(CreateEmploymentOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
		...
		try {
			...
			result = dueDiligenceResource.createEmploymentDetails(methodID, inputArray, dcRequest, dcResponse);
		} catch (Exception e) {
