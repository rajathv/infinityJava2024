 ...
 */
public class GetEmploymentOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetEmploymentOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
		...
		try {
			...
			result = dueDiligenceResource.getEmploymentDetails(methodID, inputArray, dcRequest, dcResponse);
		} catch (Exception e) {
