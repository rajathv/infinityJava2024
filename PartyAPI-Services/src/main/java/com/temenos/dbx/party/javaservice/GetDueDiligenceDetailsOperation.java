 ...
 */
public class GetDueDiligenceDetailsOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetDueDiligenceDetailsOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
		...
		try {
			...
			result = dueDiligenceResource.getDueDiligenceDetails(methodID, inputArray, dcRequest, dcResponse);
		} catch (Exception e) {
