 ...
 */
public class CreateTaxOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(CreateTaxOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
		...
		try {
			...
			result = dueDiligenceResource.createTaxDetail(methodID, inputArray, dcRequest, dcResponse);
		} catch (Exception e) {
