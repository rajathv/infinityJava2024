...
@IntegrationEventSubscriber(topics = { "/events/createParty" })
public class CreatePartyEventSubscriber implements EventSubscriber {
    ...
    public void onEvent(EventData eventData) {
        ...
        if(data.has("events")) {
            ...
            if(data.has("eventData")) {
                ...
                ServiceCallHelper.invokeServiceAndGetJson(inputParams, null, URLConstants.DBX_PROSPECT_CREATE);
                return;
            }
        }
