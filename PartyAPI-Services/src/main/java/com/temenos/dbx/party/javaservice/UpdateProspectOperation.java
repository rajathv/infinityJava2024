...
//        try {
//            UpdateProspectResource updateProspectResource = DBPAPIAbstractFactoryImpl.getInstance()
//                    .getFactoryInstance(ResourceFactory.class).getResource(UpdateProspectResource.class);
//            result = updateProspectResource.updateProspect(methodID, inputArray, dcRequest, dcResponse);
//        } catch (Exception e) {
...
//        }
        ...
        try {
            ...
            result = customerResourceImpl.update(methodID, inputArray, dcRequest, dcResponse);
        } catch (Exception e) {
            LOG.error("Caught exception while creating Customer: ", e);
        }
