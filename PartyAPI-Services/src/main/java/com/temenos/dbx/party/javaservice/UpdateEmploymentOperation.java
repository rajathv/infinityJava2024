 ...
 */
public class UpdateEmploymentOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(UpdateEmploymentOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
		...
		try {
			...
			result = dueDiligenceResource.updateEmploymentDetails(methodID, inputArray, dcRequest, dcResponse);
		} catch (Exception e) {
