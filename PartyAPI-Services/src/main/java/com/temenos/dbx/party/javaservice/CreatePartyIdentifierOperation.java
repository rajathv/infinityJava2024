...
public class CreatePartyIdentifierOperation implements JavaService2 {

	private LoggerUtil logger = new LoggerUtil(CreatePartyIdentifierOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
		...
		try {
			...
			result = customerResource.createIdentifier(methodID, inputArray, dcRequest, dcResponse);
		} catch (Exception e) {
