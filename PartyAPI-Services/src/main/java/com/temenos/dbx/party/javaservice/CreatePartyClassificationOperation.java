...
public class CreatePartyClassificationOperation implements JavaService2{
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest, DataControllerResponse dcResponse)
        ...
        Result result = new Result();
           try {
              ...
              result = customerResource.createPartyClassification(methodID, inputArray, dcRequest, dcResponse, false);
           } catch (Exception e) {
