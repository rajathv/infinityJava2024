 ...
 */
public class GetTaxOperation implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetTaxOperation.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
		...
		try {
			...
			result = dueDiligenceResource.getTaxDetails(methodID, inputArray, dcRequest, dcResponse);
		} catch (Exception e) {
