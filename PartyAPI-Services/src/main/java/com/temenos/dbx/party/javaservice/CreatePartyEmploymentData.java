...
import com.temenos.dbx.party.javaservice.CreateProspectOperation;
import com.temenos.dbx.party.resource.api.CustomerResource;

public class CreatePartyEmploymentData implements JavaService2{
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest, DataControllerResponse dcResponse)
        ...
        Result result = new Result();
           try {
              ...
              result = customerResource.createEmployments(methodID, inputArray, dcRequest, dcResponse, false);
           } catch (Exception e) {
