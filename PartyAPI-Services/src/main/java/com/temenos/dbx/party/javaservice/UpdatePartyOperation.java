...
public class UpdatePartyOperation implements JavaService2{
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest, DataControllerResponse dcResponse)
        ...
        Result result = new Result();
           try {
              ...
              result = customerResource.update(methodID, inputArray, dcRequest, dcResponse);
           } catch (Exception e) {
               logger.error("Caught exception while updating Customer: ",  e);
           }
