...
public class GetAllocationHCOrchPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetAllocationHCOrchPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetAllocationHCCOrchPreProcessor" + e);
			e.getMessage();
			return false;
		}
