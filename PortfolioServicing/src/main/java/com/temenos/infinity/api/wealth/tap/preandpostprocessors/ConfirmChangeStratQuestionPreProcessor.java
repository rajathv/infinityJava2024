...
public class ConfirmChangeStratQuestionPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(ConfirmChangeStratQuestionPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in ConfirmChangeStratQuestionPreProcessor-TAP" + e);
			e.getMessage();
		}
		return false;
	}
