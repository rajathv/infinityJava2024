...
public class SubmitQuesPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(SubmitQuesPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			if (request.getParameter(TemenosConstants.WEALTH_CORE) != null
				...
				inputMap.put("questionnaireHistoCode", request.getParameter("questionnaireHistoCode"));
				return true;
			...
			LOG.error("Error in SubmitQuesPreProcessor-TAP" + e);
			e.getMessage();
		}
		return false;
	}
