...
public class GetAllocationHCPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetAllocationHCPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetAllocationHCPreProcessor-TAP" + e);
			e.getMessage();
		}
		return false;
	}
