...
public class GetRiskAnalysisHCOrchPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetRiskAnalysisHCOrchPreProcessor.class);
		...
		try {
			Set<String> userPermissions = SessionScope.getAllPermissionsFromIdentityScope(request);
			 ...
			 String portfolioId = null, portfolioservicetype = "";
				...
				LOG.error("Error in GetRiskAnalysisHCOrchPreProcessor" + e);
				e.getMessage();
				return false;
			}
		}
