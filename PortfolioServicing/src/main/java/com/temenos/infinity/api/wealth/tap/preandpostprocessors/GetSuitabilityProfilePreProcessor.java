...
public class GetSuitabilityProfilePreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetSuitabilityProfilePreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetSuitabilityProfilePreProcessor-TAP" + e);
			e.getMessage();
		}
		return false;
	}
