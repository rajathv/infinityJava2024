 ...
 *
 */
public class GetAssetAllocation implements JavaService2 {
	...
	public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = portfolioDetailsResource.getAssetAllocation(methodId, inputArray, request, response);
		}
		catch(Exception e) {
			log.error("Exception in invoke of GetAssetAllocation:",e);
