...
public class GetAllStrategiesPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetAllStrategiesPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetAllStrategiesPreProcessor-T24" + e);
			e.getMessage();
		}
		return false;
	}
