 ...
 *
 */
public class GetAllocation implements JavaService2 {

	private static final Logger log = Logger.getLogger(GetPortfolioDetails.class);
	...
	public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = portfolioDetailsResource.getAllocation(methodId, inputArray, request, response);
		}
		catch(Exception e) {
			log.error("Exception in invoke of getPortfolioDetails:",e);
