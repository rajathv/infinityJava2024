...
public class GetRecommendedStrategyPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetRecommendedStrategyPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {           
			...
			LOG.error("Error in GetRecommendedStrategyPreProcessor-T24" + e);
			e.getMessage();
		}
		return false;
	}
