...
public class GetAccountActivityMock implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetAccountActivityMock.class);
	...
	public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		try {
			JSONObject resultJSON = mockUtil.mockGetAccountActivity(inputParams);
