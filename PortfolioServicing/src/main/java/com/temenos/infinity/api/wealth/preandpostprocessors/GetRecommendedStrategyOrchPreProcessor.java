...
public class GetRecommendedStrategyOrchPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetRecommendedStrategyOrchPreProcessor.class);
		...
		try {
			Set<String> userPermissions = SessionScope.getAllPermissionsFromIdentityScope(request);
			 ...
			 String portfolioId = null, portfolioservicetype = "";
				...
				LOG.error("Error in GetRecommendedStrategyOrchPreProcessor" + e);
				e.getMessage();
				return false;
			}
		}
