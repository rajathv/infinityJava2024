...
public class ConfirmChangeStratPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(ConfirmChangeStratPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in ConfirmChangeStratPreProcessor-T24" + e);
			e.getMessage();
		}
		return false;
	}
