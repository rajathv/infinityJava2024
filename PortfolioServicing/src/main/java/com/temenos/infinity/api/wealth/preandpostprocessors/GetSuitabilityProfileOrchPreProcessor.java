...
public class GetSuitabilityProfileOrchPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetSuitabilityProfileOrchPreProcessor.class);
		...
		try {
			Set<String> userPermissions = SessionScope.getAllPermissionsFromIdentityScope(request);
			 ...
			 String portfolioId = null, portfolioservicetype = "";
				...
				LOG.error("Error in GetSuitabilityProfileOrchPreProcessor" + e);
				e.getMessage();
				return false;
			}
		}
