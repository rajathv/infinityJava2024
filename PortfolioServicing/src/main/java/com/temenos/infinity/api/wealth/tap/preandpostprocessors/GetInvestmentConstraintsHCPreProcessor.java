...
public class GetInvestmentConstraintsHCPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetInvestmentConstraintsHCPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetInvestmentConstraintsHCPreProcessor-TAP" + e);
			e.getMessage();
		}
		return false;
	}
