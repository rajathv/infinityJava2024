...
public class GetInvestmentConstraintsHCOrchPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetInvestmentConstraintsHCOrchPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetInvestmentConstraintsHCOrchPreProcessor" + e);
			e.getMessage();
			return false;
		}
	}
