...
public class GetMyStrategyPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetMyStrategyPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetMyStrategyPreProcessor-T24" + e);
			e.getMessage();
		}
		return false;
	}
