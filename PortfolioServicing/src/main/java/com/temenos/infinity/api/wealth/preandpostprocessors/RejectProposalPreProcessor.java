...
public class RejectProposalPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(RejectProposalPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in RejectProposalPreProcessor-T24" + e);
			e.getMessage();
		}
		return false;
	}
