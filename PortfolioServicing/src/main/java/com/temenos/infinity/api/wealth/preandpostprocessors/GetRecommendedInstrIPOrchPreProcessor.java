...
public class GetRecommendedInstrIPOrchPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetRecommendedInstrIPOrchPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetRecommendedInstrumentsIPOrchPreProcessor" + e);
			e.getMessage();
			return false;
		}
