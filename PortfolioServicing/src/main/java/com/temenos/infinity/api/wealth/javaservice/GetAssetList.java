 ...
 *
 */
public class GetAssetList implements JavaService2 {

	private static final Logger log = LogManager.getLogger(GetAssetList.class);
	...
	public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result = wealthDashboardResource.getAssetList(methodId, inputArray, request, response);
		}
		catch(Exception e) {
			log.error("Exception in invoke of GetAssetList:",e);
