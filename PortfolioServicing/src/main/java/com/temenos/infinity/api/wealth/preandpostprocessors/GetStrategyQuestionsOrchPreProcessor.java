...
public class GetStrategyQuestionsOrchPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetStrategyQuestionsOrchPreProcessor.class);
