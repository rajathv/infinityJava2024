 ...
 *
 */
public class GetInstrumentTotalMock implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetInstrumentTotalMock.class);
	...
	public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		try {
			JSONObject cashBalance = mockUtil.mockGetInstrumentTotal(inputMap);
