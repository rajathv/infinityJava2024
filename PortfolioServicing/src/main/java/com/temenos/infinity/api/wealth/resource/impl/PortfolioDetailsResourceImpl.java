...
public class PortfolioDetailsResourceImpl implements PortfolioDetailsResource {
	...
	public Result getInstrumentTotal(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		result= portfolioDetailsBusinessDelegate.getInstrumentTotal(methodID, inputArray, request, response, headersMap);
		return result;
	}
	...
	public Result getAssetAllocation(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		result= portfolioDetailsBusinessDelegate.getAssetAllocation(methodID, inputArray, request, response, headersMap);
		return result;
	}
	...
	public Result getPortfolioDetails(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		PortfolioDetailsBusinessDelegate portfolioDetailsBusinessDelegate = DBPAPIAbstractFactoryImpl.
				getBusinessDelegate(PortfolioDetailsBusinessDelegate.class);
		result= portfolioDetailsBusinessDelegate.getPortfolioDetails(methodID, inputArray, request, response, headersMap);
		return result;
	}
	...
	public Result getPortfolioHealth(String methodID, Object[] inputArray, DataControllerRequest request,
		 ...
		 * SessionScope.getAllPermissionsFromIdentityScope(request); if
		 * (!userPermissions.contains("WEALTH_PORTFOLIO_DETAILS_ASSET_ALLOCATION_VIEW")&
		 * & !userPermissions.contains("WEALTH_PORTFOLIO_DETAILS_CASH_BALANCE_VIEW")&&
		 * !userPermissions.contains("WEALTH_PORTFOLIO_DETAILS_SUMMARY_VIEW")) {
		 * //ErrorCodeEnum.ERR_12001.setErrorCode(result); return result; }
		 */
		PortfolioDetailsBusinessDelegate portfolioDetailsBusinessDelegate = DBPAPIAbstractFactoryImpl.
				getBusinessDelegate(PortfolioDetailsBusinessDelegate.class);
		result= portfolioDetailsBusinessDelegate.getPortfolioHealth(methodID, inputArray, request, response, headersMap);
		return result;
	}
	...
	public Result getAllocation(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		PortfolioDetailsBusinessDelegate portfolioDetailsBusinessDelegate = DBPAPIAbstractFactoryImpl.
				getBusinessDelegate(PortfolioDetailsBusinessDelegate.class);
		result= portfolioDetailsBusinessDelegate.getAllocation(methodId, inputArray, request, response, headersMap);
		return result;
