...
public class GetRecommendedInstrumentsHCOrchPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetRecommendedInstrumentsHCOrchPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
            ...
            if (!userPermissions.contains(TemenosConstants.PORTFOLIO_HEALTH_RECOMMENDED_INSTRUMENTS_VIEW)) {
			...
			LOG.error("Error in GetRecommendedInstrumentsHCOrchPreProcessor" + e);
			e.getMessage();
			return false;
		}
	}
