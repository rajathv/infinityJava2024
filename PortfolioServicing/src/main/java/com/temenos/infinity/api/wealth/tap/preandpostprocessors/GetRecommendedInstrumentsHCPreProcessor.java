...
public class GetRecommendedInstrumentsHCPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetRecommendedInstrumentsHCPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetRecommendedInstrumentsHCPreProcessor-TAP" + e);
			e.getMessage();
		}
		return false;
	}
