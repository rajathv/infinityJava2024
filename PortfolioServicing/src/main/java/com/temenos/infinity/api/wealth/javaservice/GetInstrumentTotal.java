 ...
 *
 */
public class GetInstrumentTotal implements JavaService2 {
	
	private static final Logger log = LogManager.getLogger(GetInstrumentTotal.class);
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest request,
		...
		try {
			...
			result  = portfolioDetailsResource.getInstrumentTotal(methodID, inputArray, request, response);
		}
		catch(Exception e){
			log.error("Caught exception at invoke of GetInstrumentTotal: ", e);
