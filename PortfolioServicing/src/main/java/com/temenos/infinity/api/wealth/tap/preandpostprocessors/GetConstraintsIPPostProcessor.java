...
public class GetConstraintsIPPostProcessor implements DataPostProcessor2 {
	...
	public Object execute(Result result, DataControllerRequest request, DataControllerResponse response)
		...
		constraintObj.put("constraintDetails", constraint);
		...
		if (flag == true) {
			performanceRes.addParam("investmentConstraintComment", "Some issues with your portfolio health");
			performanceRes.addParam("investmentConstraintStatus", "1");
		} else {
