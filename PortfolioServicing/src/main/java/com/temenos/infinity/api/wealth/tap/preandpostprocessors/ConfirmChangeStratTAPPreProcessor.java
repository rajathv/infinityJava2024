...
public class ConfirmChangeStratTAPPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(ConfirmChangeStratTAPPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in ConfirmChangeStratTAPPreProcessor-TAP" + e);
			e.getMessage();
		}
		return false;
	}
