...
public class GetStrategyPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetStrategyPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetStrategyAllocationPreProcessor-T24" + e);
			e.getMessage();
		}
		return false;
	}
