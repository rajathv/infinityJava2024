...
public class ConfirmOrdersIPOrchPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(ConfirmOrdersIPOrchPreProcessor.class);
...
//			 }
	            ...
	            if ((allportfoliosList.contains(portfolioId) && portfolioservicetype.equalsIgnoreCase("Advisory"))|| (allportfoliosList.contains(portfolioId)))
	            {          
