...
public class GetPortfolioHealthPreProcessor implements DataPreProcessor2 {
	private static final Logger LOG = LogManager.getLogger(GetPortfolioHealthPreProcessor.class);
	...
	public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
		...
		try {
			...
			LOG.error("Error in GetPortfolioHealthPreProcessor-TAP" + e);
			e.getMessage();
		}
		return false;
	}
