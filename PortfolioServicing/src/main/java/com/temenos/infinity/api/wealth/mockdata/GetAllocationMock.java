 ...
 *
 */
public class GetAllocationMock implements JavaService2 {
	private static final Logger LOG = LogManager.getLogger(GetAllocationMock.class);
	...
	public Object invoke(String methodId, Object[] inputArray, DataControllerRequest request,
		...
		try {
			JSONObject assestAllocation = mockUtil.mockGetAllocation(inputMap);
